        ...
        sections: [
            {
                ...
                flashcards: [
                    ...
                    { question: 'C\'est quoi la derivee d\'un produit u*v ?', answer: 'Formule : (u*v)\' = u\'*v + u*v\'. En gros : "derivee du 1er FOIS le 2eme + le 1er FOIS derivee du 2eme." Exemple : f(x) = x * e^x. u = x, u\' = 1. v = e^x, v\' = e^x. f\'(x) = 1*e^x + x*e^x = (1+x)*e^x. Astuce : il y a un PLUS au milieu. Ne pas confondre avec le quotient (qui a un MOINS).' },
                    ...
                    { question: 'Comment trouver les variations SANS deriver ?', answer: 'On compare f(a) et f(b) directement quand a < b. Si f(b) > f(a) → f monte. Si f(b) < f(a) → f descend. On peut aussi utiliser ce qu\'on SAIT deja : x^2 descend avant 0 et monte apres 0. 1/x descend partout (sur chaque intervalle). En gros : si l\'enonce dit "sans derivee", compare directement les valeurs.' },
                    ...
                    { question: 'Comment lire une limite sur un graphique ?', answer: 'Regarde ce que fait la courbe quand x part tres loin (vers +infini ou -infini). Si la courbe se rapproche d\'une ligne horizontale y = 3, alors la limite est 3 et y = 3 est une ASYMPTOTE HORIZONTALE. Si la courbe part vers le haut ou le bas pres de x = 2, c\'est une ASYMPTOTE VERTICALE en x = 2. En gros : asymptote = ligne dont la courbe se rapproche sans jamais la toucher.' },
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'C\'est quoi le theoreme des gendarmes ?', answer: 'Si une suite v(n) est COINCEE entre deux suites u(n) et w(n) qui vont TOUTES LES DEUX vers la meme limite L, alors v(n) va aussi vers L. Imagine : tu marches entre deux gendarmes qui vont tous les deux au commissariat. Tu finiras au commissariat aussi. En gros : si t\'es coince entre deux trucs qui vont au meme endroit, tu y vas aussi.' },
            ...
            },
            {
                ...
                content: '<h3>Probabilites de base</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'C\'est quoi P(A ou B) ?', answer: 'Formule : P(A ou B) = P(A) + P(B) - P(A et B). Pourquoi le moins ? Parce que si A et B peuvent arriver en meme temps, on les compte 2 fois. Il faut retirer le doublon. Si A et B ne peuvent JAMAIS arriver en meme temps (incompatibles) : P(A ou B) = P(A) + P(B). Exemple : de a 6 faces. P(pair OU >4) = P(pair) + P(>4) - P(pair ET >4) = 3/6 + 2/6 - 1/6 = 4/6.' },
                    { question: 'C\'est quoi une probabilite conditionnelle ?', answer: 'P(A sachant B) = P(A et B) / P(B). En gros : quelle est la chance que A arrive, SI on sait DEJA que B est arrive ? Exemple : dans une classe, 60% des eleves ont un portable (B). Parmi ceux qui ont un portable, 40% ont un iPhone (A sachant B). P(iPhone ET portable) = 0.4 * 0.6 = 0.24. Piege : P(B) doit etre different de 0.' },
                    { question: 'C\'est quoi la loi binomiale ?', answer: 'On l\'utilise quand on REPETE n fois la meme experience avec 2 resultats possibles (succes/echec). P(X = k) = C(n,k) * p^k * (1-p)^(n-k). En gros : "combien de chances d\'avoir exactement k succes sur n essais ?" Exemple : 10 lancers de piece, proba d\'avoir exactement 3 piles. Quand l\'utiliser : repeter, independant, 2 issues, meme proba.' },
                    { question: 'C\'est quoi l\'esperance ?', answer: 'Formule (loi binomiale) : E(X) = n * p. C\'est la MOYENNE attendue. En gros : si tu repetes l\'experience plein de fois, c\'est le nombre moyen de succes. Exemple : tu lances un de 100 fois. Proba de 6 = 1/6. E(X) = 100 * 1/6 = ~16,7. En moyenne, tu auras ~17 fois le 6. Mots difficiles : "esperance" = la valeur moyenne qu\'on s\'attend a obtenir.' },
                    ...
                    { question: 'C\'est quoi l\'equiprobabilite ?', answer: 'C\'est quand tous les resultats ont la MEME chance d\'arriver. Dans ce cas : P(A) = cas favorables / cas totaux. Exemple : un de equilibre, chaque face a 1 chance sur 6. P(pair) = 3 faces paires / 6 faces totales = 1/2. Piege : un de pipe n\'est PAS equiprobable. Une piece truquee non plus. En gros : equiprobabilite = tout le monde a la meme chance.' },
                    { question: 'Quand utiliser la loi binomiale ?', answer: 'Checklist : 1) On REPETE la meme chose n fois. 2) Chaque essai est INDEPENDANT. 3) Il y a exactement 2 issues (succes ou echec). 4) La proba de succes p est TOUJOURS la meme. Si les 4 conditions sont remplies → binomiale. Repere dans l\'enonce : "on repete", "independant", "succes/echec", "meme probabilite." Exemple type : lancer une piece n fois, tirer avec remise.' },
                    { question: 'C\'est quoi l\'independance en proba ?', answer: 'A et B sont independants si P(A et B) = P(A) * P(B). En gros : savoir que B est arrive ne change PAS la chance de A. Exemple : un de rouge et un de bleu. Le rouge ne change pas le bleu. P(6 rouge ET 6 bleu) = 1/6 * 1/6 = 1/36. Piege Bac : independant n\'est PAS la meme chose qu\'incompatible ! Incompatible = ils ne peuvent pas arriver en meme temps. Independant = l\'un n\'influence pas l\'autre.' },
                    { question: 'Comment utiliser un arbre de probas ?', answer: 'Regles simples : 1) Chaque branche porte une proba. 2) Les branches qui partent du meme point = somme = 1. 3) Pour un CHEMIN : on MULTIPLIE les probas. 4) Pour un EVENEMENT : on ADDITIONNE les chemins qui y menent. Exemple : P(A) = 0,6 puis P(B sachant A) = 0,3. P(A et B) = 0,6 * 0,3 = 0,18. Astuce : dessine TOUJOURS l\'arbre. C\'est le meilleur outil en probas.' },
            ...
            // =====================================================================
            {
                ...
                flashcards: [
                    ...
                    { question: 'L\'integrale ca represente quoi concretement ?', answer: 'C\'est l\'AIRE sous la courbe entre a et b. Si la courbe est AU-DESSUS de l\'axe x → aire positive. Si elle est EN-DESSOUS → aire negative. Piege Bac : si on demande une AIRE (pas une integrale), il faut prendre la valeur absolue quand la courbe passe en dessous. En gros : integrale = aire signee (+ au-dessus, - en-dessous).' },
            ...
            // =====================================================================
            {
                ...
                content: '<h3>Limites en l\'infini</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Limite de e^x quand x est tres grand ou tres petit ?', answer: 'Quand x → +infini : e^x → +infini (ca explose, ca monte tres vite). Quand x → -infini : e^x → 0 (ca s\'ecrase vers 0, mais ne passe JAMAIS en negatif). En gros : e^x est toujours POSITIF. A droite ca explose, a gauche ca s\'ecrase. Mots difficiles : "tendre vers" = se rapprocher de plus en plus d\'une valeur sans forcement l\'atteindre.' },
                    ...
                    { question: 'Comment trouver la limite d\'un polynome ?', answer: 'Regarde SEULEMENT le terme avec le plus grand exposant. Tout le reste est negligeable. Exemple : lim(3x^3 - 1000x^2 + 5) quand x → +infini = lim(3x^3) = +infini. Le -1000x^2 parait enorme, mais 3x^3 le depasse quand x est tres grand. En gros : le terme de plus haut degre gagne toujours.' },
