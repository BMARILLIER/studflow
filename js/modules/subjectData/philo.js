        ...
        sections: [
            {
                ...
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce que la verite comme adequation ?', answer: '\uD83D\uDC49 La verite = correspondance entre ce qu\'on dit et ce qui est. Formule classique : adaequatio rei et intellectus (Thomas d\'Aquin). Ex : "il pleut" est vrai si et seulement s\'il pleut. \uD83C\uDFAF Cle Bac : c\'est la definition de reference — a connaitre puis a nuancer (Nietzsche, pragmatisme).' },
                    { question: 'Peut-on atteindre la verite ?', answer: '\uD83D\uDC49 Descartes : oui, par le doute methodique et la raison. Nietzsche : non, "il n\'y a pas de faits, seulement des interpretations". Kant : on connait les phenomenes, jamais la chose en soi. \uD83C\uDFAF Cle Bac : plan ideal = oui (rationalisme) / non (scepticisme) / synthese (Kant : verite = limites).' }
                ],
                quiz: [
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'L\'Etat est-il un obstacle ou une condition de la liberte ?', answer: '\uD83D\uDC49 Obstacle : anarchistes — l\'Etat opprime. Condition : Hobbes — sans Etat, guerre de tous contre tous. Rousseau — l\'Etat du contrat social REALISE la liberte. \uD83C\uDFAF Cle Bac : sujet recurrent — plan : obstacle (Marx, anarchisme) / condition (Hobbes, Rousseau) / synthese (Etat juste vs Etat oppresseur).' },
                    { question: 'Qu\'est-ce que la justice selon Rawls ?', answer: '\uD83D\uDC49 Des principes equitables choisis sous le "voile d\'ignorance" (sans connaitre sa place dans la societe). Resultat : proteger les plus defavorises + egalite des chances. \uD83D\uDCCC Principe de difference : les inegalites ne sont justes que si elles profitent aux plus desavantages. \uD83C\uDFAF Cle Bac : Rawls = justice comme EQUITE (pas egalite stricte).' },
                    { question: 'La justice est-elle la meme chose que la legalite ?', answer: '\uD83D\uDC49 Non. Legal = conforme a la loi. Juste = conforme a un ideal moral. Ex : l\'esclavage etait legal mais injuste. Antigone desobeit a la loi au nom de la justice. \uD83C\uDFAF Cle Bac : toujours distinguer legal/juste — c\'est LE piege classique du sujet justice.' }
                ],
                quiz: [
            ...
            // ========== NOUVELLES SECTIONS ==========
            {
                ...
                flashcards: [
                    ...
                    { question: 'Peut-on etre libre sans loi ?', answer: '\uD83D\uDC49 Non selon Rousseau : sans loi, c\'est la loi du plus fort, pas la liberte. La loi qu\'on se donne soi-meme (volonte generale) EST la liberte. \uD83D\uDCCC Hobbes : sans loi = guerre de tous contre tous. \uD83C\uDFAF Cle Bac : sujet classique — opposer Hobbes (loi = securite) et Rousseau (loi = liberte).' },
                    { question: 'La liberte est-elle l\'absence de contrainte ?', answer: '\uD83D\uDC49 Liberte negative = oui (pas d\'obstacle). Mais liberte positive = pouvoir EFFECTIF d\'agir. Ex : un SDF est "libre" legalement mais pas libre de fait. \uD83D\uDCCC Kant : la vraie liberte = l\'autonomie (se donner sa propre loi). \uD83C\uDFAF Cle Bac : toujours distinguer liberte negative/positive en dissertation.' },
                    { question: 'L\'homme est-il libre ou determine ?', answer: '\uD83D\uDC49 Spinoza : determine (on ignore les causes). Sartre : absolument libre (condamne a choisir). Compromis : Kant distingue le monde phenomenal (determine) et le monde noumenal (libre). \uD83C\uDFAF Cle Bac : le plan ideal = these (determine) / antithese (libre) / synthese (Kant ou compatibilisme).' }
                ],
                quiz: [
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'La conscience est-elle un obstacle ou une condition du bonheur ?', answer: '\uD83D\uDC49 Obstacle : la conscience nous fait voir nos limites et notre mortalite (Pascal : "roseau pensant"). Condition : sans conscience, pas de plaisir ni de sens. \uD83C\uDFAF Cle Bac : sujet frequent — opposer conscience-souffrance (Pascal) et conscience-liberte (Sartre).' },
                    { question: 'Suis-je ce que j\'ai conscience d\'etre ?', answer: '\uD83D\uDC49 Descartes : oui, la conscience est transparente. Freud : non, l\'inconscient me determine a mon insu. Sartre : je suis ce que je fais, pas ce que je crois etre (mauvaise foi). \uD83C\uDFAF Cle Bac : sujet type — plan : oui (Descartes) / non (Freud) / je me construis par mes actes (Sartre).' }
                ],
                quiz: [
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'L\'art doit-il imiter la nature ?', answer: '\uD83D\uDC49 Platon : oui, mais c\'est une copie de copie (cave = illusion). Hegel : non, l\'art DEPASSE la nature en revelant l\'Idee. Art abstrait : l\'art cree ses propres formes. \uD83C\uDFAF Cle Bac : plan classique — oui (mimesis) / non (creation) / l\'art revele ce que la nature cache.' },
                    { question: 'A quoi sert l\'art ?', answer: '\uD83D\uDC49 Kant : a rien (beaute desinteressee). Hegel : reveler la verite. Nietzsche : affirmer la vie. Sartre : l\'art engage politiquement. Ex : Guernica de Picasso = denonciation. \uD83C\uDFAF Cle Bac : ne JAMAIS dire "l\'art ne sert a rien" — dire "l\'art est desinteresse" (nuance Kant).' }
                ],
                quiz: [
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'Agir par devoir ou par interet : quelle difference ?', answer: '\uD83D\uDC49 Par devoir (Kant) : j\'agis parce que c\'est JUSTE, meme si ca ne m\'arrange pas. Par interet : j\'agis parce que ca me profite. Ex : rendre un portefeuille par honnetete (devoir) vs pour la recompense (interet). \uD83C\uDFAF Cle Bac : Kant = seule l\'intention compte, pas le resultat. Opposer a l\'utilitarisme (resultat).' },
                    { question: 'A-t-on le droit de desobeir a la loi ?', answer: '\uD83D\uDC49 Antigone : oui, au nom de lois divines superieures. Thoreau/MLK : oui, de maniere non-violente et en acceptant la sanction. Hobbes : non, l\'obeissance garantit la paix. \uD83C\uDFAF Cle Bac : sujet type — plan : non (Hobbes, ordre) / oui (conscience morale) / synthese (desobeissance civile encadree).' },
                    { question: 'Qu\'est-ce que le devoir selon Kant ?', answer: '\uD83D\uDC49 La necessite d\'agir par respect pour la loi morale, independamment de nos desirs. Ex : dire la verite meme quand ca nous dessert. \uD83D\uDCCC Devoir ≠ contrainte : le devoir est choisi par la raison, pas impose de l\'exterieur. \uD83C\uDFAF Cle Bac : devoir = autonomie de la raison. Heteronomie = obeir par peur ou habitude.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                content: '<h3>Langage, pensee et communication</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Pourquoi Aristote dit-il que l\'homme est un "animal politique" ?', answer: '\uD83D\uDC49 L\'homme possede le logos (parole + raison), ce qui lui permet de debattre du juste et de l\'injuste. Ex : seul l\'homme peut argumenter en assemblee. \uD83C\uDFAF Cle Bac : logos = parole ET raison, pas juste "langage".' },
                    { question: 'Qu\'est-ce que l\'arbitraire du signe chez Saussure ?', answer: '\uD83D\uDC49 Aucun lien naturel entre le mot (signifiant) et le concept (signifie). Ex : "arbre" en francais, "tree" en anglais — meme concept, sons differents. \uD83C\uDFAF Cle Bac : arbitraire = conventionnel, pas "au hasard".' },
                    { question: 'Que signifie "les limites de mon langage signifient les limites de mon monde" (Wittgenstein) ?', answer: '\uD83D\uDC49 Ce qu\'on ne peut pas dire, on ne peut pas le penser. Le langage trace les frontieres du pensable. Ex : un peuple sans mot pour "liberte" ne peut pas penser ce concept. \uD83C\uDFAF Cle Bac : langage = condition de la pensee, pas simple outil.' },
                    { question: 'Pourquoi Bergson critique-t-il le langage ?', answer: '\uD83D\uDC49 Les mots sont des etiquettes generales qui figent la realite. Ex : le mot "tristesse" ne capte pas VOTRE tristesse precise. \uD83D\uDCCC La duree vecue est continue, le langage la decoupe. \uD83C\uDFAF Cle Bac : opposer langage (general) a experience (singuliere).' },
                    { question: 'Comment Benveniste relie-t-il langage et conscience de soi ?', answer: '\uD83D\uDC49 C\'est en disant "je" qu\'on se constitue comme sujet. Le langage n\'est pas un outil : c\'est le lieu ou nait la subjectivite. Ex : un enfant devient "quelqu\'un" quand il dit "je". \uD83C\uDFAF Cle Bac : subjectivite = produit du langage.' },
                    { question: 'Qu\'est-ce que la novlangue dans 1984 d\'Orwell ?', answer: '\uD83D\uDC49 Une langue appauvrie par le pouvoir pour empecher la pensee critique. Ex : supprimer le mot "liberte" rend impossible l\'idee de se revolter. \uD83D\uDCCC Controler les mots = controler les idees. \uD83C\uDFAF Cle Bac : illustre la these "le langage conditionne la pensee".' },
                    { question: 'Qu\'est-ce que le pouvoir symbolique selon Bourdieu ?', answer: '\uD83D\uDC49 Le pouvoir d\'imposer sa vision du monde par la maitrise de la langue dominante. Ex : parler "bien" en entretien donne un avantage social invisible. \uD83C\uDFAF Cle Bac : langage = instrument de domination sociale, pas seulement communication.' },
                    { question: 'Quelle est la position de Merleau-Ponty sur le langage ?', answer: '\uD83D\uDC49 Le langage n\'habille pas la pensee : il EST la pensee en acte. Parler, c\'est penser. Ex : on decouvre ce qu\'on pense en le formulant. \uD83C\uDFAF Cle Bac : contre l\'idee que la pensee existe avant les mots.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                content: '<h3>La decouverte de l\'inconscient</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Quelles sont les trois instances du psychisme selon Freud ?', answer: '\uD83D\uDC49 Ca (pulsions, "je veux"), Moi (raison, "je gere"), Surmoi (morale, "tu ne dois pas"). Ex : envie de tricher (ca), tu resistes (moi), car c\'est mal (surmoi). \uD83C\uDFAF Cle Bac : ca = plaisir, moi = realite, surmoi = interdits.' },
                    { question: 'Comment l\'inconscient se manifeste-t-il selon Freud ?', answer: '\uD83D\uDC49 Par les reves, lapsus, actes manques et symptomes nevrotiques — ce sont des "retours du refoule". Ex : dire le nom de son ex a son/sa copain(e) = lapsus revelateur. \uD83C\uDFAF Cle Bac : le reve = "voie royale vers l\'inconscient".' },
                    { question: 'Que signifie "le moi n\'est pas maitre dans sa propre maison" (Freud) ?', answer: '\uD83D\uDC49 On croit agir librement, mais des forces inconscientes (pulsions, desirs refoules) influencent nos choix a notre insu. \uD83D\uDCCC 3e blessure narcissique apres Copernic et Darwin. \uD83C\uDFAF Cle Bac : remet en cause la transparence de la conscience a elle-meme.' },
                    { question: 'Pourquoi Sartre rejette-t-il l\'inconscient freudien ?', answer: '\uD83D\uDC49 C\'est de la mauvaise foi : on se cache derriere l\'inconscient pour fuir sa responsabilite. Ex : "c\'est pas moi, c\'est mon inconscient" = excuse. \uD83C\uDFAF Cle Bac : Sartre defend la liberte totale CONTRE l\'alibi de l\'inconscient.' },
                    { question: 'Qu\'est-ce que le refoulement selon Freud ?', answer: '\uD83D\uDC49 Le moi repousse dans l\'inconscient les desirs juges inacceptables. Mais le refoule cherche a revenir (reves, symptomes). Ex : un traumatisme oublie qui genere des angoisses. \uD83C\uDFAF Cle Bac : refoulement ≠ oubli volontaire, c\'est un mecanisme inconscient.' },
                    { question: 'Que sont les "petites perceptions" de Leibniz ?', answer: '\uD83D\uDC49 Des perceptions trop faibles pour etre conscientes, mais qui influencent l\'esprit. Ex : chaque vague est inaudible, mais l\'ensemble = bruit de la mer. \uD83C\uDFAF Cle Bac : Leibniz prefigure l\'inconscient AVANT Freud (a citer en intro).' },
                    { question: 'Comment Alain critique-t-il l\'idee d\'inconscient ?', answer: '\uD83D\uDC49 Croire a l\'inconscient, c\'est renoncer a sa responsabilite. Pour Alain, tout ce qui est mental est conscient. Ex : on sait toujours pourquoi on agit, meme si on refuse de l\'admettre. \uD83C\uDFAF Cle Bac : Alain + Sartre = meme camp CONTRE Freud.' },
                    { question: 'Quel role Nietzsche attribue-t-il aux pulsions ?', answer: '\uD83D\uDC49 La conscience n\'est que la surface. Les pulsions et la volonte de puissance sont les vraies forces qui guident nos actes. Ex : la morale est un masque pour des pulsions de domination. \uD83C\uDFAF Cle Bac : Nietzsche critique l\'inconscient AVANT Freud — bon precurseur a citer.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                content: '<h3>Nature et objet du desir</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Comment Platon definit-il le desir dans Le Banquet ?', answer: '\uD83D\uDC49 Le desir nait du manque : on desire ce qu\'on n\'a pas. Eros est fils de Richesse et Pauvrete = tension permanente. Ex : on desire l\'amour parce qu\'on se sent incomplet. \uD83C\uDFAF Cle Bac : desir = manque chez Platon (a opposer a Spinoza).' },
                    { question: 'Quels sont les trois types de desirs selon Epicure ?', answer: '\uD83D\uDC49 1) Naturels + necessaires (manger). 2) Naturels + non necessaires (gastronomie). 3) Ni naturels ni necessaires (gloire, richesse). \uD83D\uDCCC Seuls les 1ers menent au bonheur. \uD83C\uDFAF Cle Bac : classification a connaitre par coeur, tombe tres souvent.' },
                    { question: 'Pourquoi Spinoza dit-il que "le desir est l\'essence de l\'homme" ?', answer: '\uD83D\uDC49 Le desir (conatus) est l\'elan vital. On ne desire pas une chose parce qu\'elle est bonne — elle est bonne PARCE QU\'on la desire. Ex : j\'aime la musique parce que je la desire, pas l\'inverse. \uD83C\uDFAF Cle Bac : Spinoza INVERSE le rapport desir/valeur — opposer a Platon.' },
                    { question: 'Pourquoi le desir est-il source de souffrance selon Schopenhauer ?', answer: '\uD83D\uDC49 Insatisfait = souffrance. Satisfait = ennui, puis nouveau desir. L\'homme est un pendule entre les deux. Ex : on desire un telephone, on l\'obtient, on en veut un autre. \uD83C\uDFAF Cle Bac : vision pessimiste a opposer a Spinoza (desir = joie).' },
                    { question: 'Qu\'est-ce que le desir de reconnaissance chez Hegel ?', answer: '\uD83D\uDC49 Le desir humain n\'est pas desir d\'objets mais desir d\'etre reconnu par l\'autre comme sujet libre. Ex : on veut etre admire, respecte, pas juste nourri. \uD83C\uDFAF Cle Bac : desir de reconnaissance = moteur de la dialectique maitre-esclave.' },
                    { question: 'Qu\'est-ce que le desir mimetique selon Rene Girard ?', answer: '\uD83D\uDC49 On desire ce que L\'AUTRE desire. Le desir est imitation, pas spontaneite. Triangle : sujet-modele-objet. Ex : un jouet ne t\'interesse que quand un autre enfant le prend. \uD83C\uDFAF Cle Bac : Girard = le desir est social, pas individuel.' },
                    { question: 'Comment les stoiciens proposent-ils de maitriser le desir ?', answer: '\uD83D\uDC49 Distinguer ce qui depend de nous (nos jugements) et ce qui n\'en depend pas (la mort, la fortune). Desirer seulement ce qui est en notre pouvoir. Ex : Epictete enchaine mais libre en esprit. \uD83C\uDFAF Cle Bac : stoicisme = sagesse par la limitation des desirs.' },
                    { question: 'Pourquoi Nietzsche refuse-t-il de supprimer les desirs ?', answer: '\uD83D\uDC49 Supprimer les desirs = nier la vie. Nietzsche defend l\'affirmation joyeuse de la volonte de puissance. Ex : l\'ascete qui se prive est hostile a la vie. \uD83C\uDFAF Cle Bac : Nietzsche CONTRE stoiciens et chretiens — critique de l\'ascetisme.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                content: '<h3>Qu\'est-ce que la religion ?</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Que signifie "la religion est l\'opium du peuple" (Marx) ?', answer: '\uD83D\uDC49 La religion soulage la souffrance comme un anesthesiant, mais empeche de se revolter. Ex : "tu souffriras au paradis" calme la revolte des opprimes. \uD83C\uDFAF Cle Bac : opium = a la fois consolation ET obstacle a l\'emancipation.' },
                    { question: 'Que signifie "Dieu est mort" chez Nietzsche ?', answer: '\uD83D\uDC49 Les valeurs chretiennes ne fondent plus notre civilisation. La science a tue Dieu, mais on n\'a rien mis a la place. Ex : crise du sens dans le monde moderne. \uD83C\uDFAF Cle Bac : "Dieu est mort" = constat, pas celebration. C\'est un probleme pour Nietzsche.' },
                    { question: 'Comment Freud explique-t-il la religion ?', answer: '\uD83D\uDC49 C\'est une illusion : on projette un pere protecteur face a l\'angoisse de la mort. Ex : prier = chercher la protection d\'un pere cosmique. \uD83D\uDCCC Illusion ≠ erreur (une illusion exprime un desir). \uD83C\uDFAF Cle Bac : Freud dit illusion, pas mensonge — nuance importante.' },
                    { question: 'Qu\'est-ce que le pari de Pascal ?', answer: '\uD83D\uDC49 Face a l\'incertitude, il est rationnel de parier sur Dieu : gain infini (vie eternelle) si Dieu existe, perte finie sinon. Ex : comme un pari ou tu risques peu et gagnes gros. \uD83C\uDFAF Cle Bac : le pari n\'est pas une preuve de Dieu mais un calcul de probabilite.' },
                    { question: 'Comment Durkheim definit-il la religion ?', answer: '\uD83D\uDC49 Un fait social : croyances + rites qui soudent une communaute. Le sacre = la societe elle-meme transfiguree. Ex : adorer un totem, c\'est en fait celebrer le groupe. \uD83C\uDFAF Cle Bac : Durkheim = approche sociologique, pas theologique.' },
                    { question: 'Quelle est la position de Kant sur l\'existence de Dieu ?', answer: '\uD83D\uDC49 La raison ne peut ni prouver ni refuter Dieu. Mais la morale a besoin de Dieu comme postulat (garantir que le bien sera recompense). Ex : sans Dieu, pourquoi etre moral ? \uD83C\uDFAF Cle Bac : Kant nie les preuves de Dieu MAIS garde Dieu comme exigence morale.' },
                    { question: 'Qu\'est-ce que le "saut de la foi" chez Kierkegaard ?', answer: '\uD83D\uDC49 La foi n\'est pas rationnelle : c\'est un saut dans l\'absurde, un engagement passionnel. Ex : Abraham pret a sacrifier son fils = foi au-dela de la logique. \uD83C\uDFAF Cle Bac : foi CONTRE raison chez Kierkegaard (opposer a Kant qui les concilie).' },
                    { question: 'Quelle distinction fait-on entre foi et superstition ?', answer: '\uD83D\uDC49 Foi = engagement personnel assumant l\'indemontrabilite. Superstition = croyance irrationnelle en des pouvoirs magiques. Ex : prier ≠ croire qu\'un chat noir porte malheur. \uD83C\uDFAF Cle Bac : la foi assume le doute, la superstition l\'ignore.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                content: '<h3>La rencontre avec autrui</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Que signifie "l\'enfer, c\'est les autres" (Sartre) ?', answer: '\uD83D\uDC49 Le regard d\'autrui me fige, me juge, me reduit a une image. Ex : dans Huis clos, 3 personnes se jugent eternellement sans pouvoir s\'echapper. \uD83C\uDFAF Cle Bac : NE PAS comprendre "les gens sont mechants" — c\'est le REGARD d\'autrui qui est l\'enfer.' },
                    { question: 'Qu\'est-ce que l\'ethique du visage chez Levinas ?', answer: '\uD83D\uDC49 Le visage d\'autrui est nu, vulnerable, et m\'ordonne "tu ne tueras point" AVANT toute reflexion. Ex : croiser un SDF nous interpelle immediatement. \uD83C\uDFAF Cle Bac : chez Levinas, l\'ethique est PREMIERE (avant l\'ontologie) — ca le distingue de tous les autres.' },
                    { question: 'Pourquoi Hegel dit-il que la conscience de soi a besoin d\'autrui ?', answer: '\uD83D\uDC49 On ne peut se connaitre seul : j\'ai besoin qu\'un autre me reconnaisse comme sujet libre. Ex : un exploit sans temoin n\'existe pas. \uD83C\uDFAF Cle Bac : reconnaissance mutuelle = moteur de la dialectique maitre-esclave.' },
                    { question: 'Comment Husserl explique-t-il l\'acces a autrui ?', answer: '\uD83D\uDC49 Par analogie : je vois un corps semblable au mien et je lui attribue une vie interieure. Autrui = alter ego (un autre moi). Ex : je vois quelqu\'un pleurer, je "sais" qu\'il souffre. \uD83C\uDFAF Cle Bac : appresentation = je ne vois pas sa conscience, je la deduis.' },
                    { question: 'Que signifie "traiter autrui comme une fin" (Kant) ?', answer: '\uD83D\uDC49 Ne jamais utiliser quelqu\'un UNIQUEMENT comme un outil. Chaque personne a une dignite inconditionnelle. Ex : payer quelqu\'un = ok, mais le traiter comme une machine = non. \uD83C\uDFAF Cle Bac : 2e formulation de l\'imperatif categorique — a connaitre par coeur.' },
                    { question: 'Que signifie "on ne nait pas femme, on le devient" (Beauvoir) ?', answer: '\uD83D\uDC49 L\'identite feminine est construite par la societe, pas par la biologie. Le regard d\'autrui et les normes fabriquent "la femme". Ex : on apprend aux filles a etre douces. \uD83C\uDFAF Cle Bac : autrui (societe) construit nos identites — lien avec le sujet "culture".' },
                    { question: 'Comment Merleau-Ponty concoit-il le rapport a autrui ?', answer: '\uD83D\uDC49 Autrui n\'est pas un probleme mais une evidence. Des la naissance, on percoit l\'autre comme un sujet par l\'intercorporeite. Ex : un bebe imite les sourires. \uD83C\uDFAF Cle Bac : Merleau-Ponty depasse le "probleme d\'autrui" — le corps nous relie directement.' },
                    { question: 'Pourquoi le regard d\'autrui est-il ambivalent chez Sartre ?', answer: '\uD83D\uDC49 Positif : autrui me revele a moi-meme (honte, fierte). Negatif : son regard me fige en objet. Ex : etre surpris en train d\'ecouter a une porte = honte revelatrice. \uD83C\uDFAF Cle Bac : autrui = miroir necessaire MAIS aussi menace pour ma liberte.' }
                ],
                quiz: [
