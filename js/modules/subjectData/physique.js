        ...
        sections: [
            {
                ...
                content: '<h3>Lois de Newton et forces</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Enoncer la premiere loi de Newton.', answer: 'Dans un referentiel galileen, tout corps isole ou pseudo-isole persevere dans son etat de repos ou de mouvement rectiligne uniforme. C\'est le principe d\'inertie.' },
                    { question: 'Enoncer le Principe Fondamental de la Dynamique (2eme loi de Newton).', answer: 'Somme des forces exterieures = m * a. L\'acceleration d\'un corps est proportionnelle a la resultante des forces et inversement proportionnelle a sa masse.' },
                    { question: 'Enoncer la troisieme loi de Newton.', answer: 'Principe des actions reciproques : si A exerce F(A/B) sur B, alors B exerce F(B/A) = -F(A/B) sur A. Meme droite d\'action, meme intensite, sens opposes.' },
                    { question: 'Quelle est la formule du poids ?', answer: 'P = m * g, ou m est la masse en kg et g l\'intensite de la pesanteur (environ 9,81 m/s^2 sur Terre). Le poids est en newtons (N).' },
                    { question: 'Quelles sont les equations horaires de la chute libre verticale sans vitesse initiale ?', answer: 'v(t) = g*t et y(t) = (1/2)*g*t^2 (axe oriente vers le bas). La vitesse augmente lineairement et la position est parabolique.' },
                    { question: 'Quelle est la formule de l\'energie cinetique ?', answer: 'Ec = (1/2)*m*v^2, avec m en kg, v en m/s. L\'energie cinetique est en joules (J).' },
                    { question: 'Quelle est la formule de l\'energie potentielle de pesanteur ?', answer: 'Ep = m*g*h, ou h est l\'altitude par rapport a une reference choisie. Ep est en joules.' },
                    { question: 'Qu\'est-ce que l\'energie mecanique et quand est-elle conservee ?', answer: 'Em = Ec + Ep. Elle est conservee lorsque seules des forces conservatives (poids, force elastique) travaillent. Les frottements dissipent l\'energie mecanique.' },
                    { question: 'Quelle est la formule de l\'acceleration centripete ?', answer: 'a = v^2 / R = R * omega^2, dirigee vers le centre du cercle. R est le rayon, v la vitesse tangentielle, omega la vitesse angulaire.' },
                    { question: 'Qu\'est-ce qu\'un referentiel galileen ?', answer: 'Un referentiel dans lequel le principe d\'inertie est verifie. En pratique, le referentiel terrestre est considere galileen pour des experiences de courte duree.' },
                    { question: 'Enoncer le theoreme de l\'energie cinetique.', answer: 'La variation d\'energie cinetique entre deux points est egale a la somme des travaux de toutes les forces : Delta(Ec) = somme(W_forces).' },
                    { question: 'Quelle est la relation entre vitesse tangentielle et vitesse angulaire ?', answer: 'v = R * omega, ou R est le rayon en metres et omega la vitesse angulaire en rad/s. La vitesse v est en m/s.' },
                    { question: 'Comment s\'exprime le travail d\'une force constante ?', answer: 'W(F) = F * AB * cos(alpha), ou alpha est l\'angle entre le vecteur force et le vecteur deplacement. W est en joules.' },
                    { question: 'Quel est le lien entre force et energie potentielle ?', answer: 'F = -dEp/dx (en une dimension). La force derive de l\'energie potentielle : elle pointe vers les potentiels decroissants.' },
                    { question: 'Comment determiner la trajectoire d\'un projectile ?', answer: 'On applique le PFD : ax = 0, ay = -g (axe y vers le haut). On integre pour obtenir vx = v0*cos(alpha), vy = -g*t + v0*sin(alpha), puis x(t) et y(t). La trajectoire y(x) est une parabole.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                content: '<h3>Formes d\'energie et conservation</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Enoncer le premier principe de la thermodynamique.', answer: 'Delta(U) = W + Q. La variation d\'energie interne d\'un systeme est egale a la somme du travail W et du transfert thermique Q recus par le systeme.' },
                    { question: 'Quelles sont les trois formes de transfert thermique ?', answer: 'Conduction (contact, sans deplacement de matiere), convection (deplacement de matiere dans un fluide), rayonnement (ondes electromagnetiques, pas besoin de matiere).' },
                    { question: 'Quelle est la formule du transfert thermique lie a une variation de temperature ?', answer: 'Q = m * c * Delta(T), ou m est la masse (kg), c la capacite thermique massique (J/(kg.K)), Delta(T) la variation de temperature (K ou degres C).' },
                    { question: 'Comment definit-on le rendement energetique ?', answer: 'eta = E_utile / E_absorbee = P_utile / P_absorbee. Il est compris entre 0 et 1 (souvent exprime en pourcentage). Un rendement de 1 signifierait aucune perte.' },
                    { question: 'Qu\'est-ce qu\'un flux thermique ?', answer: 'Phi = Q / Delta(t), exprime en watts (W). C\'est la puissance thermique, c\'est-a-dire l\'energie thermique transferee par unite de temps.' },
                    { question: 'Enoncer le principe de conservation de l\'energie.', answer: 'L\'energie totale d\'un systeme isole est constante. L\'energie ne se cree pas et ne se detruit pas, elle se transforme d\'une forme a une autre.' },
                    { question: 'Qu\'est-ce que la capacite thermique massique ?', answer: 'C\'est la grandeur c dans Q = m*c*Delta(T). Elle represente l\'energie necessaire pour elever de 1 K la temperature de 1 kg de substance. Unite : J/(kg.K). Ex : eau c = 4180 J/(kg.K).' },
                    { question: 'Quelle est la difference entre energie et puissance ?', answer: 'L\'energie (en joules J) est une quantite totale. La puissance (en watts W) est un debit d\'energie : P = E / t. 1 W = 1 J/s.' },
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce que la radioactivite gamma ?', answer: 'Le noyau dans un etat excite emet un photon gamma (rayonnement electromagnetique tres energetique) pour se desexciter. Ni A ni Z ne changent. Souvent accompagne une desintegration alpha ou beta.' },
                    { question: 'Quelle est la loi de decroissance radioactive ?', answer: 'N(t) = N0 * e^(-lambda*t), ou N0 est le nombre initial de noyaux, lambda la constante radioactive (s^-1), t le temps. C\'est une decroissance exponentielle.' },
                    { question: 'Quelle est la definition de la demi-vie ?', answer: 'La demi-vie t1/2 est le temps au bout duquel la moitie des noyaux radioactifs se sont desintegres. t1/2 = ln(2) / lambda. Apres n demi-vies, il reste N0 / 2^n noyaux.' },
                    { question: 'Quelle est la formule E = mc^2 ?', answer: 'L\'equivalence masse-energie d\'Einstein : l\'energie associee a une masse m est E = m * c^2, ou c = 3 * 10^8 m/s. 1 u correspond a 931,5 MeV.' },
                    { question: 'Qu\'est-ce que le defaut de masse ?', answer: 'Delta(m) = Z*mp + (A-Z)*mn - m_noyau. La masse du noyau est inferieure a la somme des masses de ses nucleons separes. Cette difference correspond a l\'energie de liaison via E = Delta(m) * c^2.' },
                    { question: 'Qu\'est-ce que l\'energie de liaison par nucleon ?', answer: 'E_l/A = energie de liaison divisee par le nombre de nucleons. Plus E_l/A est grande, plus le noyau est stable. Le maximum est atteint pour le fer-56 (environ 8,8 MeV/nucleon).' },
                    { question: 'Qu\'est-ce que la fission nucleaire ?', answer: 'Un noyau lourd (ex : uranium-235) absorbe un neutron et se scinde en deux noyaux plus legers, avec liberation de neutrons et d\'une grande quantite d\'energie. Principe des centrales nucleaires.' },
                    { question: 'Qu\'est-ce que la fusion nucleaire ?', answer: 'Deux noyaux legers (ex : deuterium + tritium) fusionnent pour former un noyau plus lourd (helium) + un neutron + energie. C\'est la reaction des etoiles. Necessite des temperatures extremes (millions de degres).' },
                    { question: 'Qu\'est-ce que l\'activite radioactive ?', answer: 'A(t) = lambda * N(t) = A0 * e^(-lambda*t), en becquerels (Bq). 1 Bq = 1 desintegration par seconde. Elle diminue exponentiellement avec le temps.' },
                    { question: 'Que sont des isotopes ?', answer: 'Des atomes ayant le meme numero atomique Z (meme element chimique) mais des nombres de masse A differents (nombre de neutrons different). Ex : H-1, H-2 (deuterium), H-3 (tritium).' },
                    { question: 'Comment fonctionne la datation au carbone-14 ?', answer: 'Le C-14 est radioactif (t1/2 = 5730 ans). Un organisme vivant maintient un ratio C-14/C-12 constant. Apres sa mort, le C-14 decroit. En mesurant le rapport actuel, on calcule le temps ecoule depuis la mort.' },
                    { question: 'Pourquoi la fission et la fusion liberent-elles de l\'energie ?', answer: 'Car les produits ont une energie de liaison par nucleon (E_l/A) plus grande que les reactifs. La courbe d\'Aston montre que les noyaux proches du fer sont les plus stables. La fission des lourds et la fusion des legers vont vers le fer.' }
                ],
                quiz: [
