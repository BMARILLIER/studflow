        ...
        sections: [
            ...
            },
            {
                ...
                content: '<h3>L\'Etat et le pouvoir</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'C\'est quoi le contrat social ?', answer: 'C\'est un ACCORD (reel ou imaginaire) entre les gens : chacun renonce a une partie de sa liberte en echange de la PROTECTION de l\'Etat. Avant le contrat = l\'etat de nature (pas de lois, pas de police). Apres le contrat = la societe organisee. En gros : on echange un peu de liberte contre la securite. Mots difficiles : "contrat social" = l\'accord fondateur de la societe. "Etat de nature" = comment les humains vivaient avant la societe (fiction philosophique).' },
                    ...
                    { question: 'Comment Rousseau voit l\'etat de nature ?', answer: 'L\'INVERSE de Hobbes. Pour Rousseau, l\'homme est naturellement BON et libre. C\'est la SOCIETE qui le corrompt. La propriete privee cree la jalousie et l\'inegalite. En gros : Hobbes dit "l\'homme est un loup pour l\'homme." Rousseau dit "l\'homme nait bon, la societe le rend mauvais." 2 visions opposees, les 2 au Bac.' },
                    { question: 'C\'est quoi le voile d\'ignorance (Rawls) ?', answer: 'Une experience de PENSEE : imagine que tu dois choisir les regles de la societe SANS SAVOIR quelle place tu auras (riche ou pauvre, homme ou femme, valide ou handicape). Resultat : tu choisis des regles qui protegent les PLUS FAIBLES (car tu pourrais etre l\'un d\'eux). En gros : si tu ne sais pas ou tu vas atterrir, tu crees un monde juste pour tout le monde. Mots difficiles : "equite" = justice adaptee a chaque situation (pas egalite stricte).' },
                    { question: 'C\'est quoi la separation des pouvoirs (Montesquieu) ?', answer: 'Montesquieu dit : pour eviter la tyrannie, il faut separer 3 pouvoirs. LEGISLATIF = faire les lois. EXECUTIF = les appliquer. JUDICIAIRE = juger. Si une seule personne a les 3, c\'est la dictature. "Le pouvoir arrete le pouvoir." En gros : 3 pouvoirs independants = liberte. 1 seul pouvoir = tyrannie. C\'est le fondement de la democratie moderne.' },
                    ...
                    { question: 'C\'est quoi la critique marxiste de l\'Etat ?', answer: 'Pour Marx, l\'Etat n\'est PAS neutre. Il sert les interets de la CLASSE DOMINANTE (les riches, les patrons). La democratie est une FACADE : les vrais decisions sont economiques. Les lois protegent la propriete des riches, pas les droits des pauvres. En gros : l\'Etat = un outil au service des riches selon Marx. Mots difficiles : "bourgeoisie" = la classe qui possede les moyens de production. "Proletariat" = les travailleurs.' },
                    { question: 'Droit naturel vs droit positif ?', answer: 'DROIT NATUREL = droits que tu as parce que tu es HUMAIN. Ils existent avant les lois (liberte, vie, egalite). DROIT POSITIF = les lois ecrites et votees par les institutions (Code civil, Constitution). En gros : le droit naturel dit "tout humain est libre." Le droit positif dit "voici les regles de CE pays." Le probleme : ils ne sont pas toujours d\'accord (l\'esclavage etait legal mais contraire au droit naturel).' },
                    { question: 'L\'Etat est-il un obstacle ou une condition de la liberte ?', answer: '3 reponses : 1) OBSTACLE = l\'Etat opprime (Marx, anarchistes). 2) CONDITION = sans Etat, c\'est le chaos, donc pas de liberte (Hobbes). 3) CA DEPEND = un Etat JUSTE libere (Rousseau), un Etat injuste opprime. Au Bac : plan ideal = obstacle / condition / synthese (tout depend du TYPE d\'Etat).' },
                    { question: 'C\'est quoi la justice selon Rawls ?', answer: 'Rawls dit : les inegalites ne sont justes QUE SI elles profitent aux PLUS DEFAVORISES. Principe de difference : un PDG peut gagner plus qu\'un ouvrier SI ca cree des emplois pour les plus pauvres. Sinon, c\'est injuste. En gros : pas d\'egalite stricte, mais l\'EQUITE — les plus faibles doivent y gagner. Mots difficiles : "equite" = justice qui tient compte des differences de situation.' },
                    { question: 'Justice = legalite ?', answer: 'NON. LEGAL = conforme a la loi. JUSTE = conforme a la morale. L\'esclavage etait LEGAL mais pas JUSTE. Antigone desobeit a la loi pour faire ce qui est JUSTE (enterrer son frere). En gros : une loi peut etre injuste. Et desobeir a une loi injuste peut etre juste. Piege Bac : TOUJOURS distinguer legal et juste — c\'est LE piege classique.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'C\'est quoi la duree de Bergson ?', answer: 'Bergson distingue 2 temps : le temps de l\'HORLOGE (minutes, heures = quantitatif, mesurable) et le temps VECU (= la duree). La duree c\'est ton experience interieure du temps. 5 minutes d\'ennui semblent une eternite. 2 heures avec un ami passent en un eclair. En gros : le temps de l\'horloge ne correspond PAS au temps ressenti. La duree = le temps tel que tu le VIS.' },
                    { question: 'C\'est quoi l\'angoisse existentialiste ?', answer: 'C\'est un sentiment DIFFERENT de la peur. La peur a un OBJET (peur du chien, peur de l\'examen). L\'angoisse n\'a PAS d\'objet precis. C\'est le sentiment vertigineux qui revele ta LIBERTE : tu peux faire n\'importe quoi, rien n\'est decide. Ca fait peur. En gros : l\'angoisse = le vertige de la liberte. On a peur parce qu\'on est libre et responsable de tout. Mots difficiles : "neant" = le rien, l\'absence de sens predetermine.' },
                    { question: 'C\'est quoi la phenomenologie ?', answer: 'C\'est une methode inventee par Husserl : on etudie les choses TELLES QU\'ELLES APPARAISSENT a la conscience, sans prejuges. Au lieu de dire "qu\'est-ce que la pomme EN SOI ?", on dit "comment la pomme m\'APPARAIT-elle ?" En gros : etudier l\'experience directe, pas les theories. Mots difficiles : "phenomene" = ce qui apparait a la conscience. "Epoche" = mettre entre parentheses ses prejuges pour observer sans biais.' },
