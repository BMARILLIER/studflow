        ...
        sections: [
            {
                ...
                flashcards: [
                    ...
                    { question: 'Quels philosophes ont inspire la Revolution ?', answer: '3 noms a retenir : 1) VOLTAIRE = tolerance, liberte d\'expression, lutte contre le fanatisme. 2) ROUSSEAU = le pouvoir appartient au peuple (souverainete populaire), contrat social. 3) MONTESQUIEU = separation des pouvoirs (legislatif, executif, judiciaire). En gros : les Lumieres ont donne les IDEES, la Revolution les a mises en PRATIQUE.' },
                    { question: 'Comment Napoleon arrive au pouvoir ?', answer: 'Par un COUP D\'ETAT le 9 novembre 1799 (18 Brumaire). Il renverse le gouvernement et prend le pouvoir. D\'abord "Premier Consul" (1799), puis EMPEREUR (1804). Il met fin a la Revolution. En gros : un general militaire profite du chaos pour prendre le pouvoir. Mots difficiles : "coup d\'Etat" = prendre le pouvoir par la force, sans elections. "18 Brumaire" = la date dans le calendrier revolutionnaire.' }
                ],
                quiz: [
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'C\'est quoi les proces de Nuremberg ?', answer: 'Des PROCES en 1945-1946 ou les principaux chefs nazis sont juges pour leurs crimes. Accusations : crimes de GUERRE (violer les lois de la guerre), crimes contre l\'HUMANITE (Shoah), crimes contre la PAIX (declencher la guerre). Certains sont condamnes a mort, d\'autres a la prison. En gros : pour la premiere fois, des dirigeants sont juges pour avoir commis des atrocites au nom d\'un Etat. Mots difficiles : "crime contre l\'humanite" = crime grave contre des populations civiles (genocides, deportations).' }
                ],
                quiz: [
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'C\'est quoi la crise de Cuba ?', answer: 'Octobre 1962. L\'URSS installe des MISSILES NUCLEAIRES a Cuba (a 150 km des USA). Kennedy (president USA) impose un blocus naval. Le monde est a 2 DOIGTS de la guerre nucleaire pendant 13 jours. Finalement l\'URSS retire ses missiles. En gros : le moment le plus DANGEREUX de l\'histoire de l\'humanite. Mots difficiles : "blocus" = empecher tout navire d\'acceder a un endroit.' },
                    ...
                    { question: 'C\'est quoi le plan Marshall ?', answer: 'Un programme d\'aide ECONOMIQUE des USA pour reconstruire l\'Europe apres la guerre (1948-1952). 13 milliards de dollars. Double objectif : 1) Aider l\'Europe a se relever. 2) Empecher les pays europeens de devenir communistes (un pays prospere ne fait pas la revolution). En gros : les USA paient pour reconstruire l\'Europe et la garder dans leur camp. L\'URSS refuse le plan Marshall pour ses pays.' },
                    ...
                    { question: 'C\'est quoi la MAD ?', answer: 'MAD = Mutual Assured Destruction = Destruction Mutuelle Assuree. Les USA et l\'URSS ont ASSEZ de bombes nucleaires pour se detruire MUTUELLEMENT. Du coup, aucun des deux n\'ose attaquer (car il serait detruit aussi). C\'est l\'"equilibre de la terreur." En gros : on ne se fait pas la guerre PARCE QUE la guerre tuerait tout le monde. La peur empeche la guerre.' },
                    { question: 'Qu\'est-ce que le blocus de Berlin (1948-1949) ?', answer: 'Blocus terrestre impose par l\'URSS sur Berlin-Ouest pour forcer les Allies a quitter la ville. Les USA repondent par un pont aerien de 11 mois (juin 1948 - mai 1949). Astuce Bac : premiere grande crise de la Guerre froide, elle montre l\'affrontement indirect entre les deux blocs.' },
                    { question: 'Qu\'est-ce que la Detente (1962-1975) ?', answer: 'Periode d\'apaisement relatif entre les USA et l\'URSS apres la crise de Cuba. Accords SALT I (1972) sur la limitation des armes nucleaires, accords d\'Helsinki (1975). Astuce Bac : la Detente n\'empeche pas les conflits peripheriques (Vietnam, Angola).' },
                    { question: 'Qu\'est-ce que le Pacte de Varsovie ?', answer: 'Alliance militaire du bloc sovietique creee en 1955 en reponse a l\'OTAN. Regroupe l\'URSS, la Pologne, la RDA, la Tchecoslovaquie, la Hongrie, la Roumanie, la Bulgarie, l\'Albanie. Astuce Bac : a opposer a l\'OTAN (1949) pour montrer la bipolarisation du monde.' },
                ...
                quiz: [
                    ...
                    { question: 'La Detente entre les deux blocs debute apres :', options: ['La crise de Suez (1956)', 'La crise de Cuba (1962)', 'La chute du mur de Berlin (1989)', 'Le plan Marshall (1948)'], correctIndex: 1, explanation: 'La Detente (1962-1975) commence apres la crise de Cuba, avec des accords comme SALT I (1972) et Helsinki (1975), mais n\'empeche pas les conflits peripheriques.' },
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce que le FMI ?', answer: 'Le Fonds Monetaire International, cree en 1944 (Bretton Woods), veille a la stabilite financiere mondiale et prete aux Etats en difficulte. Il impose souvent des plans d\'ajustement structurel (austerite, privatisations). Astuce Bac : acteur cle de la gouvernance economique mondiale, a citer dans tout sujet sur la mondialisation.' },
                    ...
                    { question: 'Comment la Chine s\'affirme-t-elle comme puissance mondiale ?', answer: '2e economie mondiale depuis 2010, "atelier du monde", montee en gamme technologique (Huawei, 5G). Nouvelles Routes de la Soie (2013) : investissements massifs en Asie, Afrique et Europe. Astuce Bac : insister sur la rivalite sino-americaine et la strategie d\'influence globale de Pekin.' },
                ...
                quiz: [
                    ...
                    { question: 'Le FMI, cree en 1944, a pour role principal de :', options: ['Financer les guerres', 'Veiller a la stabilite financiere mondiale et preter aux Etats en difficulte', 'Reguler le commerce international', 'Distribuer l\'aide alimentaire mondiale'], correctIndex: 1, explanation: 'Le Fonds Monetaire International assure la stabilite financiere mondiale et impose souvent des plans d\'ajustement structurel aux pays emprunteurs.' },
                    { question: 'Le soft power designe la capacite d\'un Etat a :', options: ['Imposer ses decisions par la force militaire', 'Influencer les autres par l\'attractivite culturelle et les valeurs', 'Controler les matieres premieres mondiales', 'Bloquer les importations etrangeres'], correctIndex: 1, explanation: 'Le soft power (Nye) repose sur la culture, les valeurs et la diplomatie. Les USA (Hollywood, GAFAM), la France (langue, gastronomie) et la Chine (instituts Confucius) l\'utilisent.' },
                    { question: 'Les Nouvelles Routes de la Soie lancees par la Chine en 2013 illustrent :', options: ['Un repli de la Chine sur elle-meme', 'Une strategie d\'influence mondiale par les investissements', 'Un accord militaire avec l\'OTAN', 'Un programme d\'aide humanitaire de l\'ONU'], correctIndex: 1, explanation: 'Les Nouvelles Routes de la Soie sont des investissements massifs chinois en Asie, Afrique et Europe pour etendre l\'influence economique et geopolitique de Pekin.' }
                ]
            },
            // ====== NEW SECTIONS (5-10) ======
            {
            ...
            },
            {
                ...
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce que le traite de Lisbonne (2007) ?', answer: 'Traite signe le 13 decembre 2007, entre en vigueur le 1er decembre 2009, il remplace le TCE rejete en 2005. Il cree le poste de president du Conseil europeen et renforce le Parlement. Astuce Bac : dernier grand traite europeen, a connaitre pour tout sujet sur l\'approfondissement de l\'UE.' },
                    { question: 'Qu\'est-ce que la PAC (Politique Agricole Commune) ?', answer: 'Politique europeenne creee en 1962 pour moderniser l\'agriculture, assurer l\'autosuffisance alimentaire et soutenir les revenus des agriculteurs. Elle represente environ 1/3 du budget de l\'UE. Astuce Bac : exemple concret de politique commune, souvent critiquee pour ses subventions inegales.' },
                    { question: 'Quels sont les criteres de Copenhague (1993) ?', answer: 'Conditions a remplir pour adherer a l\'UE : Etat de droit, democratie, droits de l\'Homme, economie de marche viable, capacite a appliquer l\'acquis communautaire. Definis en 1993 avant l\'elargissement aux PECO (2004). Astuce Bac : montrent que l\'UE est un projet politique fonde sur des valeurs, pas seulement un marche.' },
                    { question: 'Qu\'est-ce que le couple franco-allemand dans la construction europeenne ?', answer: 'Moteur historique de l\'integration europeenne, fonde sur la reconciliation apres 1945. De Gaulle-Adenauer (traite de l\'Elysee, 1963), Mitterrand-Kohl (Maastricht), Macron-Merkel. Astuce Bac : toujours citer le couple franco-allemand comme moteur de la construction europeenne dans vos dissertations.' }
                ],
                quiz: [
                    ...
                    { question: 'Le traite de Lisbonne (2007) a ete adopte pour remplacer :', options: ['Le traite de Rome', 'Le traite de Maastricht', 'Le TCE rejete par referendum en 2005', 'L\'Acte unique europeen'], correctIndex: 2, explanation: 'Le traite de Lisbonne remplace le Traite Constitutionnel Europeen (TCE) rejete par la France et les Pays-Bas en 2005. Il cree le poste de president du Conseil europeen.' },
                    { question: 'Les criteres de Copenhague (1993) definissent :', options: ['Les regles de la zone euro', 'Les conditions d\'adhesion a l\'UE', 'Le fonctionnement du Parlement europeen', 'Les normes environnementales europeennes'], correctIndex: 1, explanation: 'Les criteres de Copenhague exigent la democratie, l\'Etat de droit, une economie de marche viable et la capacite a appliquer l\'acquis communautaire pour adherer a l\'UE.' }
                ]
            },
            {
                id: 'moyen_orient',
                ...
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce qu\'un Etat failli (failed state) ?', answer: 'Etat incapable d\'exercer ses fonctions fondamentales : securite, justice, services publics. Exemples : Somalie, Libye apres 2011, Yemen. Astuce Bac : notion essentielle pour expliquer l\'instabilite regionale, le terrorisme et les flux migratoires dans les conflits contemporains.' }
                ],
                quiz: [
                    ...
                    { question: 'La guerre en Ukraine (2022) est significative car elle :', options: ['Est le premier conflit arme depuis 1945', 'Marque le retour de la guerre en Europe et recompose la geopolitique mondiale', 'Oppose deux membres permanents du Conseil de securite de l\'ONU', 'Est un conflit exclusivement economique sans combats'], correctIndex: 1, explanation: 'L\'invasion russe du 24 fevrier 2022 remet en cause l\'ordre europeen d\'apres-Guerre froide et entraine sanctions occidentales, soutien militaire a l\'Ukraine et crise energetique.' },
                    { question: 'Un Etat failli (failed state) se caracterise par :', options: ['Un regime democratique instable mais fonctionnel', 'L\'incapacite a assurer la securite, la justice et les services publics', 'Une economie trop dependante du tourisme', 'Un gouvernement autoritaire mais efficace'], correctIndex: 1, explanation: 'Un Etat failli ne peut exercer ses fonctions fondamentales. La Somalie, la Libye apres 2011 et le Yemen en sont des exemples, generant instabilite, terrorisme et flux migratoires.' }
                ]
            },
            {
                id: 'gouverner_france',
                ...
                flashcards: [
                    ...
                    { question: 'C\'est quoi la crise du 13 mai 1958 ?', answer: 'Le 13 mai 1958 a Alger, des militaires et des Francais d\'Algerie se revolent. La France est en pleine guerre d\'Algerie et le gouvernement ne tient plus. On rappelle le general de Gaulle. Il prend le pouvoir et cree la Ve Republique (celle qu\'on a encore aujourd\'hui). En gros : c\'est la crise qui a CREE notre systeme politique actuel. Mots difficiles : "IVe Republique" = le systeme d\'avant, tres instable (22 gouvernements en 12 ans). "Ve Republique" = notre systeme actuel, avec un president fort.' },
                    { question: 'C\'est quoi Mai 68 ?', answer: 'En mai 1968, les etudiants manifestent, puis les ouvriers aussi. 10 MILLIONS de personnes font greve. La France est paralysee. De Gaulle dissout l\'Assemblee (= nouvelles elections) et gagne. Mais il demissionne l\'annee suivante (1969). En gros : c\'est la plus grande crise sociale de la Ve Republique. Mots difficiles : "greve generale" = quand presque tout le monde arrete de travailler en meme temps. "dissoudre l\'Assemblee" = le president annule le Parlement et provoque de nouvelles elections.' },
                    { question: 'C\'est quoi l\'article 49-3 ?', answer: 'C\'est un article de la Constitution qui permet au Premier ministre de faire passer une loi SANS vote des deputes. Les deputes ne peuvent le bloquer que s\'ils renversent le gouvernement (= motion de censure). En gros : le gouvernement dit "cette loi passe, sauf si vous me virez." C\'est un outil tres controverse : certains disent que c\'est antidemocratique, d\'autres que c\'est necessaire pour avancer. Mots difficiles : "motion de censure" = vote des deputes pour renverser le gouvernement. "Constitution" = le texte qui definit les regles du pays.' },
                    { question: 'C\'est quoi le quinquennat ?', answer: 'Avant 2002, le president etait elu pour 7 ans. Maintenant c\'est 5 ans. Ca a ete decide par referendum en 2000. Pourquoi ce changement ? Pour que le president et les deputes soient elus en meme temps (les deputes sont aussi elus pour 5 ans). Ca evite la cohabitation. Mots difficiles : "quinquennat" = mandat de 5 ans (du latin "quinque" = cinq). "mandat legislatif" = la duree du poste de depute (= 5 ans). "referendum" = vote ou TOUT le peuple decide directement (oui ou non). "cohabitation" = quand le president et le Premier ministre sont de partis opposes, donc ils ne sont pas d\'accord.' },
