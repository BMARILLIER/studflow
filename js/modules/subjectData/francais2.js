        ...
        sections: [
            ...
            // ================================================================
            {
                ...
                content: '<h3>La Princesse de Cleves — Mme de Lafayette (1678)</h3>'
                    ...
                    + '<h4>Contexte</h4>'
                    + '<ul>'
                    + '<li>Se deroule a la cour d\'Henri II (XVIe siecle), mais ecrit au XVIIe</li>'
                    ...
                    + '<li><strong>Le refus final</strong> : apres la mort de son mari, elle refuse Nemours et se retire du monde</li>'
                    + '</ul>'
                    + '<h4>Themes</h4>'
                    + '<ul>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Qui a ecrit La Princesse de Cleves et quand ?', answer: 'Mme de Lafayette, en 1678. En gros : une femme mariee tombe amoureuse d\'un autre homme, mais elle decide de ne pas ceder. C\'est le premier roman qui s\'interesse vraiment a ce que les personnages RESSENTENT. Mot difficile : "roman psychologique" = un roman qui explore les pensees et les emotions des personnages.' },
                    { question: 'Que se passe-t-il a la scene du bal ?', answer: 'La Princesse et le Duc de Nemours se voient pour la premiere fois. Coup de foudre. Tout le monde les regarde danser. En gros : c\'est la scene ou tout commence. Apres ca, tout le roman sera la lutte de la Princesse contre ses sentiments. Pourquoi retenir ca : c\'est LA scene que les profs adorent analyser.' },
                    { question: 'C\'est quoi "l\'aveu au mari" ?', answer: 'La Princesse dit a son mari : "Je suis amoureuse d\'un autre." Elle ne donne pas le nom. Elle lui demande de l\'aider a resister. C\'est la premiere fois dans un roman qu\'une epouse fait ca. Pourquoi c\'est fou : a l\'epoque, une femme ne disait JAMAIS ca. C\'etait totalement choquant. Mot difficile : "inedite" = qui n\'a jamais ete fait avant.' },
                    { question: 'Pourquoi elle refuse Nemours a la fin ?', answer: 'Son mari meurt de chagrin (a cause de sa passion). Elle est libre, mais elle dit non a Nemours. Pourquoi ? Elle sait que la passion ne dure pas. Elle prefere etre tranquille plutot que souffrir. En gros : elle choisit la paix plutot que l\'amour. C\'est un choix de la tete contre le coeur.' },
                    ...
                    { question: 'Pourquoi on dit que c\'est feministe avant l\'heure ?', answer: 'Parce que la Princesse CHOISIT elle-meme. Personne ne lui dit de refuser Nemours. Elle decide seule que sa tranquillite vaut plus que l\'amour. Au XVIIe siecle, une femme qui decide toute seule, c\'est revolutionnaire. En gros : elle ne se soumet a aucun homme. Mot difficile : "lucidite" = voir les choses telles qu\'elles sont, sans se raconter d\'histoires.' },
                    { question: 'C\'est quoi le "repos" dans ce roman ?', answer: 'Le "repos" = la paix interieure, ne plus souffrir. La Princesse dit : la passion c\'est de la souffrance (jalousie, doutes, larmes). Le repos c\'est la liberte. En gros : elle prefere etre seule et tranquille que amoureuse et malheureuse. Pourquoi c\'est au Bac : ca oppose RAISON (classicisme) vs PASSION (romantisme).' }
                ],
                quiz: [
                    { question: 'Quand La Princesse de Cleves a-t-elle ete publiee ?', options: ['1637', '1678', '1721', '1761'], correctIndex: 1, explanation: 'Le roman est publie en 1678 par Mme de Lafayette, a l\'epoque du classicisme.' },
                    { question: 'A quelle epoque se deroule l\'action du roman ?', options: ['Le regne de Louis XIV', 'Le regne d\'Henri II', 'La Revolution', 'Le Moyen Age'], correctIndex: 1, explanation: 'L\'action se situe a la cour d\'Henri II (XVIe siecle), mais le roman est ecrit au XVIIe siecle.' },
                    { question: 'Qu\'est-ce qui rend la scene de l\'aveu unique dans la litterature ?', options: ['C\'est une declaration d\'amour', 'Une epouse avoue sa passion pour un autre a son mari', 'Le mari pardonne immediatement', 'Nemours est present pendant l\'aveu'], correctIndex: 1, explanation: 'C\'est la premiere fois dans la litterature qu\'une femme mariee avoue a son mari qu\'elle aime un autre homme.' },
                    { question: 'Pourquoi la Princesse refuse-t-elle Nemours a la fin ?', options: ['Son mari est encore vivant', 'Elle choisit le repos plutot que la passion', 'Elle aime quelqu\'un d\'autre', 'Sa mere le lui interdit'], correctIndex: 1, explanation: 'Libre apres la mort de son mari, elle refuse quand meme Nemours par lucidite : elle sait que la passion ne dure pas.' },
                    { question: 'Quel mouvement litteraire La Princesse de Cleves represente-t-elle ?', options: ['Le romantisme', 'Le naturalisme', 'Le classicisme', 'Les Lumieres'], correctIndex: 2, explanation: 'C\'est un roman classique : analyse psychologique fine, raison qui domine les passions, sobriete du style.' },
                    ...
                    { question: 'Comment meurt M. de Cleves ?', options: ['En duel', 'De maladie', 'De chagrin apres avoir appris la passion de sa femme', 'A la guerre'], correctIndex: 2, explanation: 'M. de Cleves meurt de chagrin et de jalousie apres avoir appris que sa femme aime Nemours.' }
                ]
            },
            ...
            // ================================================================
            {
                ...
                content: '<h3>Les Fleurs du Mal — Charles Baudelaire (1857)</h3>'
                    + '<p>Recueil poetique revolutionnaire qui transforme la laideur en beaute. Baudelaire invente la <strong>modernite poetique</strong> : il trouve du beau dans le mal, le laid, la ville, l\'ennui.</p>'
                    ...
                    + '<li><strong>L\'Ideal</strong> : aspiration a la beaute pure, au monde superieur, a l\'infini</li>'
                    ...
                    + '<li><strong>L\'Alchimie poetique</strong> : transformer la "boue" (la laideur, le mal) en "or" (beaute poetique) — "Tu m\'as donne ta boue et j\'en ai fait de l\'or"</li>'
                    + '</ul>'
                    + '<h4>Poemes incontournables</h4>'
                    + '<ul>'
                    + '<li><strong>L\'Albatros</strong> : le poete est comme un oiseau majestueux en vol mais ridicule sur le pont du navire (= dans la societe)</li>'
                    ...
                    + '<li><strong>L\'Invitation au voyage</strong> : reve d\'un monde ideal, "La, tout n\'est qu\'ordre et beaute, / Luxe, calme et volupte"</li>'
                ...
                flashcards: [
                    ...
                    { question: 'Pourquoi le livre a ete interdit en 1857 ?', answer: 'Les juges ont dit que c\'etait immoral : Baudelaire parlait de sexe, de mort, de drogue. 6 poemes ont ete supprimes et il a paye une amende. En gros : la societe n\'etait pas prete pour ses idees. Mais ca l\'a rendu CELEBRE. Pourquoi c\'est important : ca pose la question — est-ce qu\'un artiste a le droit de TOUT dire ?' },
                    { question: 'Comment le livre est-il organise ?', answer: '6 parties, dans un ordre precis : 1) Spleen et Ideal (le combat interieur). 2) Tableaux parisiens (la ville). 3) Le Vin (chercher l\'oubli). 4) Fleurs du Mal (le vice). 5) Revolte (contre Dieu). 6) La Mort (la derniere sortie). En gros : c\'est un voyage de l\'espoir vers le desespoir. Pourquoi c\'est important : ce n\'est pas juste des poemes au hasard, c\'est un PARCOURS.' },
                    { question: 'C\'est quoi un "Tableau parisien" ?', answer: 'Un poeme sur la VILLE. Avant Baudelaire, la poesie parlait de la nature (fleurs, montagnes). Lui parle de Paris : les rues, la foule, les mendiants, les passants. Il trouve de la beaute dans le beton. Poeme cle : "A une passante" — il croise une belle femme dans la foule, et c\'est fini, il ne la reverra jamais. En gros : il invente la poesie URBAINE.' },
                    { question: 'C\'est quoi le poeme "Une Charogne" ?', answer: 'Baudelaire se balade avec sa copine et tombe sur un cadavre d\'animal pourri. Il le decrit (puanteur, vers, mouches). Puis il dit a sa copine : "Un jour, toi aussi tu ressembleras a ca." MAIS : le poeme, LUI, sera eternel. En gros : la beaute pourrit, mais l\'art ne meurt jamais. C\'est le meilleur exemple d\'alchimie poetique : transformer l\'horrible en beau.' },
                    { question: 'Que veut dire "luxe, calme et volupte" ?', answer: 'C\'est le refrain de "L\'Invitation au voyage." Baudelaire reve d\'un pays parfait ou tout serait beau et harmonieux. Mais ce pays n\'existe PAS. C\'est un reve, une echappatoire au Spleen. En gros : quand la realite est insupportable, le poete s\'evade par l\'imagination. Mot difficile : "volupte" = plaisir intense et delicat, presque sensuel.' },
                    { question: 'Pourquoi Baudelaire est le pere de la poesie moderne ?', answer: 'Il a TOUT change : 1) Il parle de la ville, pas que de la nature. 2) Il trouve du beau dans le laid. 3) Il parle du mal sans moraliser. 4) Il invente le symbolisme. 5) Il libere la poesie des sujets "acceptables." En gros : avant lui, la poesie avait des regles. Apres lui, plus rien n\'est interdit. TOUS les poetes apres lui lui doivent quelque chose.' }
                ],
                quiz: [
                    { question: 'En quelle annee Les Fleurs du Mal sont-elles publiees ?', options: ['1830', '1848', '1857', '1869'], correctIndex: 2, explanation: 'Les Fleurs du Mal paraissent en 1857 et sont immediatement poursuivies pour "outrage a la morale publique."' },
                    ...
                    { question: 'Dans "L\'Albatros", a quoi est compare le poete ?', options: ['A un marin', 'A un albatros majestueux en vol mais maladroit au sol', 'A un capitaine de navire', 'A un oiseau en cage'], correctIndex: 1, explanation: 'L\'albatros est une allegorie du poete : grandiose dans la creation mais inadapte et moque dans la societe.' },
                    { question: 'Qu\'est-ce que l\'alchimie poetique ?', options: ['Ecrire en vers reguliers', 'Transformer la laideur en beaute par la poesie', 'Utiliser des metaphores scientifiques', 'Ecrire des poemes en prose'], correctIndex: 1, explanation: 'Baudelaire transforme la "boue" (laideur, mal) en "or" (beaute poetique). C\'est le principe fondamental des Fleurs du Mal.' },
                    { question: 'Quel poeme definit la theorie des correspondances ?', options: ['L\'Albatros', 'Spleen', 'Correspondances', 'L\'Invitation au voyage'], correctIndex: 2, explanation: 'Le sonnet "Correspondances" pose l\'idee que les sens se repondent et que la nature est un "temple" plein de symboles.' },
                    { question: 'Pourquoi "Une Charogne" est-il un poeme d\'alchimie poetique ?', options: ['Il parle d\'or et de metaux', 'Il transforme la description d\'un cadavre en poeme d\'amour', 'Il imite les alchimistes medievaux', 'Il utilise des vers dores'], correctIndex: 1, explanation: 'Baudelaire decrit un cadavre en decomposition mais en fait un poeme sur la beaute et l\'eternite de l\'art face a la mort.' },
                    ...
                    { question: 'Baudelaire est considere comme le fondateur de quel mouvement ?', options: ['Le romantisme', 'Le Parnasse', 'Le symbolisme', 'Le surrealisme'], correctIndex: 2, explanation: 'Par sa theorie des Correspondances et son usage du symbole, Baudelaire est le precurseur direct du symbolisme (Verlaine, Rimbaud, Mallarme).' }
                ]
            },
            ...
            // ================================================================
            {
                ...
                content: '<h3>La litterature d\'idees : convaincre, persuader, deliberer</h3>'
                    + '<p>Au Bac, c\'est un objet d\'etude central. Les grands auteurs utilisent la litterature pour <strong>defendre des idees, critiquer la societe et faire reflechir</strong>.</p>'
                    ...
                    + '<li>"Que sais-je ?" : sa devise — douter de tout, meme de soi-meme</li>'
                    ...
                    + '</ul>'
                    + '<h4>Les Lumieres (XVIIIe siecle)</h4>'
                    + '<ul>'
                    ...
                    + '<li><strong>Rousseau</strong> : Discours sur l\'inegalite (1755) : l\'homme est bon par nature, c\'est la societe qui le corrompt. Du Contrat social : la souverainete appartient au peuple</li>'
                ...
                quiz: [
                    ...
                    { question: 'Quel procede utilise Montesquieu dans les Lettres persanes ?', options: ['Le monologue interieur', 'Le regard etranger', 'Le flashback', 'Le stream of consciousness'], correctIndex: 1, explanation: 'Deux Persans observent la societe francaise avec un regard naive qui revele l\'absurdite de nos coutumes.' },
                    { question: 'Selon Rousseau, qu\'est-ce qui corrompt l\'homme ?', options: ['La nature', 'La religion', 'La societe et la propriete', 'La science'], correctIndex: 2, explanation: 'Pour Rousseau, l\'homme est bon par nature. C\'est la societe, la propriete privee et la civilisation qui creent les inegalites.' },
            ...
            // ================================================================
            {
                ...
                content: '<h3>Juste la fin du monde — Jean-Luc Lagarce (1990)</h3>'
                    ...
                    + '<h4>L\'intrigue</h4>'
                    + '<ul>'
                    + '<li>Louis revient apres des annees d\'absence pour annoncer sa mort prochaine (sida, jamais nomme)</li>'
                ...
                quiz: [
                    ...
                    { question: 'Quel personnage represente la colere et la frustration ?', options: ['La Mere', 'Suzanne', 'Catherine', 'Antoine'], correctIndex: 3, explanation: 'Antoine, le frere aine, est agressif et plein de reproches envers Louis qui l\'a "abandonne" avec la famille.' },
                    { question: 'Quelle maladie Louis a-t-il ?', options: ['Le cancer', 'Le sida (jamais nomme dans la piece)', 'La tuberculose', 'Une maladie imaginaire'], correctIndex: 1, explanation: 'La maladie n\'est jamais nommee. Le non-dit est le sujet meme de l\'oeuvre. Lagarce lui-meme est mort du sida.' }
                ]
            },
            ...
            // ================================================================
            {
                ...
                content: '<h3>Declaration des droits de la femme et de la citoyenne — Olympe de Gouges (1791)</h3>'
                    ...
                    + '<h4>Contexte</h4>'
                    + '<ul>'
                    + '<li>La Revolution de 1789 proclame "liberte, egalite, fraternite" mais EXCLUT les femmes</li>'
                    ...
                    + '<li>Si la femme peut monter a l\'echafaud (etre guillotinee), elle doit pouvoir monter a la tribune (parler en public)</li>'
                    + '<li>Denonciation de l\'esclavage et de toutes les formes d\'oppression</li>'
                    + '<li>Revendication du droit a l\'education, au divorce, a la propriete</li>'
                    + '</ul>'
                    + '<h4>Strategies argumentatives</h4>'
                    + '<ul>'
                ...
                flashcards: [
                    ...
                    { question: 'Pourquoi c\'est un texte feministe fondateur ?', answer: 'C\'est le PREMIER texte politique qui dit clairement : les femmes doivent avoir les MEMES droits que les hommes. Gouges ne supplie pas. Elle ARGUMENTE avec logique. Et elle le fait en 1791, bien avant tout le monde. En gros : c\'est le point de depart du feminisme politique. Pourquoi c\'est au Bac : ca melange litterature + argumentation + histoire des droits.' }
                ],
                quiz: [
                    { question: 'En quelle annee Olympe de Gouges ecrit-elle sa Declaration ?', options: ['1789', '1791', '1793', '1804'], correctIndex: 1, explanation: 'La Declaration des droits de la femme et de la citoyenne est ecrite en 1791, deux ans apres la Declaration des droits de l\'homme.' },
                    { question: 'Quel procede Gouges utilise-t-elle pour denoncer l\'inegalite ?', options: ['La metaphore', 'Le pastiche de la Declaration de 1789', 'Le roman epistolaire', 'Le conte philosophique'], correctIndex: 1, explanation: 'Elle reprend la Declaration de 1789 article par article en la reecrivant pour inclure les femmes, revelant les manques du texte original.' },
                    { question: 'Que signifie "monter a la tribune" dans le texte de Gouges ?', options: ['Aller au tribunal', 'Prendre la parole publiquement et faire de la politique', 'Monter sur scene', 'Ecrire des livres'], correctIndex: 1, explanation: 'La tribune est le lieu ou l\'on prend la parole dans les assemblees politiques. Gouges revendique le droit des femmes a la participation politique.' },
                    ...
                    { question: 'Quand les femmes ont-elles obtenu le droit de vote en France ?', options: ['1791', '1848', '1918', '1944'], correctIndex: 3, explanation: 'Il a fallu attendre 1944 — soit 153 ans apres le texte de Gouges — pour que les femmes obtiennent le droit de vote.' }
                ]
            },
            ...
            // ================================================================
            {
                ...
                content: '<h3>L\'oral du Bac de Francais — Comment reussir</h3>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'C\'est quoi une explication lineaire ?', answer: 'Tu prends un texte et tu l\'expliques DANS L\'ORDRE, du debut a la fin. Pour chaque bout de texte : 1) Tu CITES les mots. 2) Tu dis quel procede c\'est (metaphore, ironie...). 3) Tu expliques l\'EFFET (pourquoi l\'auteur fait ca). En gros : c\'est pas "de quoi parle le texte" mais "COMMENT l\'auteur le dit." C\'est l\'exercice numero 1 de l\'oral.' },
                    ...
                    { question: 'C\'est quoi un procede et comment l\'analyser ?', answer: 'Un procede, c\'est une TECHNIQUE que l\'auteur utilise. Exemples : metaphore, ironie, repetition. Pour l\'analyser en 3 etapes : 1) NOMMER ("c\'est une metaphore"). 2) CITER ("\'cette faucille d\'or\'"). 3) EFFET ("ca compare la lune a un outil, ca rend le ciel familier"). L\'erreur numero 1 : reperer un procede sans dire a quoi il SERT. Ca vaut zero.' },
                ...
                quiz: [
                    ...
                    { question: 'Que faut-il faire quand on repere un procede litteraire ?', options: ['Juste le nommer', 'Le nommer, le citer et expliquer son effet', 'L\'ignorer si on ne connait pas le nom', 'Le traduire en langage courant'], correctIndex: 1, explanation: 'Nommer le procede + citer le texte + expliquer l\'effet. C\'est la methode en 3 etapes. Sans l\'effet, l\'analyse ne vaut rien.' },
            ...
            // ================================================================
            {
                ...
                icon: '\u270F\uFE0F',
                content: '<h3>La poesie du XIXe au XXe siecle</h3>'
                    ...
                    + '</ul>'
                    + '<h4>Le surrealisme (XXe siecle)</h4>'
                    + '<ul>'
                ...
                quiz: [
                    ...
                    { question: 'Selon Verlaine, que faut-il privilegier en poesie ?', options: ['L\'eloquence', 'La rime riche', 'La musique', 'La description precise'], correctIndex: 2, explanation: '"De la musique avant toute chose" : Verlaine veut une poesie musicale et suggestive, pas descriptive ou eloquente.' },
