        ...
        sections: [
            {
                ...
                content: '<h3>Lois de Newton et forces</h3>'
                    ...
                    + '<li><strong>2eme loi (PFD)</strong> : somme des forces = m * a (Principe Fondamental de la Dynamique). L\'acceleration est proportionnelle à la force nette et inversement proportionnelle à la masse</li>'
                    + '<li><strong>3eme loi (action-reaction)</strong> : si A exerce une force F(A/B) sur B, alors B exerce sur A une force F(B/A) = -F(A/B), de même droite d\'action</li>'
                    ...
                    + '</ul>'
                    + '<h3>Mouvement circulaire et énergie mecanique</h3>'
                    + '<ul>'
                    ...
                    + '<li><strong>Theoreme de l\'énergie cinetique</strong> : Delta(Ec) = somme des travaux des forces</li>'
                    + '</ul>',
                flashcards: [
                    { question: 'C\'est quoi la 1ere loi de Newton (inertie) ?', answer: 'Un objet qui ne subit aucune force reste comme il est : s\'il est arrete, il reste arrete. S\'il bouge, il continue en ligne droite à la même vitesse. En gros : sans force, rien ne change. Exemple : dans l\'espace (pas de frottement), un objet lance continue a avancer pour toujours. Mots difficiles : "inertie" = tendance d\'un objet a ne pas changer d\'etat. "referentiel galileen" = un point de vue ou cette loi marche (ex : le sol terrestre).' },
                    ...
                    { question: 'C\'est quoi la 3eme loi de Newton (action-reaction) ?', answer: 'Si tu pousses un mur, le mur te pousse aussi avec la même force, mais dans l\'autre sens. Toute force à une force egale en retour. En gros : quand A pousse B, B pousse A exactement pareil mais a l\'envers. Exemple : quand tu marches, ton pied pousse le sol vers l\'arriere et le sol te pousse vers l\'avant. C\'est pour ca que tu avances.' },
                    { question: 'C\'est quoi la formule du poids ?', answer: 'P = m x g. P = poids (en newtons). m = masse (en kg). g = 9,81 (c\'est la force de gravite sur Terre). En gros : le poids c\'est la force avec laquelle la Terre t\'attire vers le bas. Exemple : une personne de 60 kg à un poids de 60 x 9,81 = environ 589 newtons. Mots difficiles : "newton" = unite de force (symbole N). "pesanteur" = la force de gravite terrestre.' },
                    { question: 'Chute libre : quelles formules ?', answer: 'Vitesse : v = g x t (la vitesse augmente avec le temps). Position : y = (1/2) x g x t^2 (la distance augmente de plus en plus vite). En gros : un objet qui tombe accelere. Apres 1s il va a 10 m/s, après 2s a 20 m/s. Exemple : tu laches une balle du 3eme etage. Elle va de plus en plus vite jusqu\'au sol. C\'est la gravite qui l\'accelere.' },
                    { question: 'C\'est quoi l\'énergie cinetique ?', answer: 'Formule : Ec = (1/2) x m x v^2. C\'est l\'énergie d\'un objet PARCE QU\'IL BOUGE. En gros : plus c\'est lourd et rapide, plus il y a d\'énergie. Exemple : une voiture a 130 km/h a BEAUCOUP plus d\'énergie qu\'a 50 km/h. C\'est pour ca qu\'un accident a haute vitesse est plus grave. Mots difficiles : "cinetique" = qui concerne le mouvement (du grec "kinesis" = mouvement). Voir le schéma : Énergie mécanique.' },
                    { question: 'C\'est quoi l\'énergie potentielle ?', answer: 'Formule : Ep = m x g x h. C\'est l\'énergie d\'un objet PARCE QU\'IL EST EN HAUTEUR. En gros : plus c\'est haut, plus il y a d\'énergie stockee. Exemple : un livre sur une etagere a de l\'énergie potentielle. S\'il tombe, cette énergie se transforme en mouvement (énergie cinetique). Mots difficiles : "potentielle" = qui est stockee, en attente d\'etre utilisee. "pesanteur" = la gravite terrestre.' },
                    { question: 'C\'est quoi l\'énergie mecanique ?', answer: 'Formule : Em = Ec + Ep (mouvement + hauteur). En gros : c\'est le total de l\'énergie de mouvement + l\'énergie de hauteur. Si rien ne frotte, ce total ne change JAMAIS. Exemple : une balle lancee en l\'air. Elle monte (Ec diminue, Ep augmente). Elle redescend (Ep diminue, Ec augmente). Le total reste le meme. Mots difficiles : "conservee" = qui ne change pas. "forces conservatives" = forces qui ne font pas perdre d\'énergie (comme le poids).' },
                    ...
                    { question: 'C\'est quoi un referentiel galileen ?', answer: 'C\'est un endroit d\'observation ou les lois de Newton marchent correctement. En gros : si tu fais une expérience les pieds sur le sol, les lois de Newton marchent. Si tu fais la même expérience dans un bus qui freine, ca ne marche plus pareil (tout glisse). Le sol = referentiel galileen. Le bus qui freine = non galileen. Mots difficiles : "referentiel" = le point de vue depuis lequel tu observes le mouvement.' },
                    { question: 'C\'est quoi le theoreme de l\'énergie cinetique ?', answer: 'La variation d\'énergie cinetique = la somme de tous les travaux des forces. En gros : si des forces poussent un objet, il accelere (son énergie cinetique augmente). Si des forces le freinent, il ralentit (son énergie cinetique diminue). Exemple : tu pousses un carton sur le sol. La force de poussee lui donne de l\'énergie cinetique. Les frottements lui en enlevent.' },
                    ...
                    { question: 'C\'est quoi le lien entre force et énergie potentielle ?', answer: 'La force pousse TOUJOURS vers l\'endroit ou l\'énergie potentielle est plus basse. En gros : une balle roule toujours vers le bas d\'une pente. La pente = l\'énergie potentielle qui diminue. La force = ce qui fait rouler la balle. Formule : F = -dEp/dx (la force est l\'oppose de la pente d\'énergie).' },
                ...
                quiz: [
                    ...
                    { question: 'L\'énergie cinetique d\'un objet de 2 kg a 3 m/s vaut :', options: ['6 J', '9 J', '18 J', '3 J'], correctIndex: 1, explanation: 'Ec = (1/2)*m*v^2 = (1/2)*2*9 = 9 J.' },
                    ...
                    { question: 'L\'énergie mecanique est conservee quand :', options: ['Il y a des frottements', 'Seules des forces conservatives travaillent', 'La vitesse est constante', 'L\'acceleration est nulle'], correctIndex: 1, explanation: 'L\'énergie mecanique Em = Ec + Ep est conservee en l\'absence de forces non conservatives (frottements, forces dissipatives).' },
                    { question: 'La troisieme loi de Newton stipule que :', options: ['F = m*a', 'Les forces vont par paires egales et opposees', 'Un corps au repos reste au repos', 'L\'énergie se conserve'], correctIndex: 1, explanation: 'Principe des actions reciproques : F(A/B) = -F(B/A). Toute action entraine une reaction egale et opposee.' },
                    { question: 'Un objet de 5 kg à une altitude de 10 m à une énergie potentielle de (g = 10 m/s^2) :', options: ['50 J', '500 J', '100 J', '250 J'], correctIndex: 1, explanation: 'Ep = m*g*h = 5 * 10 * 10 = 500 J.' },
                    ...
                    { question: 'Le theoreme de l\'énergie cinetique relie :', options: ['Force et vitesse', 'Variation d\'Ec et somme des travaux des forces', 'Masse et acceleration', 'Ep et Ec uniquement'], correctIndex: 1, explanation: 'Delta(Ec) = somme des travaux de toutes les forces appliquees entre les deux positions.' },
                    ...
                    { question: 'La pression exercee par un fluide au repos à une profondeur h est donnee par :', options: ['P = rho * h', 'P = rho * g * h + P_atm', 'P = m * g * h', 'P = g * h'], correctIndex: 1, explanation: 'La pression dans un fluide au repos à la profondeur h est P = P_atm + rho * g * h, ou rho est la masse volumique du fluide, g l\'acceleration de la pesanteur et P_atm la pression atmospherique en surface.' }
                ]
            },
            {
                id: 'énergie',
                ...
                icon: '\u26A1',
                content: '<h3>Formes d\'énergie et conservation</h3>'
                    + '<ul>'
                    + '<li><strong>Formes d\'énergie</strong> : cinetique (Ec = (1/2)mv^2), potentielle (Ep), thermique (Eth), electrique, chimique, nucleaire, rayonnante</li>'
                    + '<li><strong>Premier principe de la thermodynamique</strong> : Delta(U) = W + Q. La variation d\'énergie interne est egale à la somme du travail et du transfert thermique recus</li>'
                    + '<li><strong>Conservation de l\'énergie</strong> : l\'énergie totale d\'un système isole est constante. Elle peut se transformer mais ne se créé ni ne se détruit</li>'
                    + '</ul>'
                    + '<h3>Transferts thermiques</h3>'
                    + '<ul>'
                    + '<li><strong>Conduction</strong> : transfert par contact entre milieux materiels, sans deplacement de matière (ex : barre metallique chauffee)</li>'
                    + '<li><strong>Convection</strong> : transfert par deplacement de matière (ex : courants dans un fluide chauffe)</li>'
                    + '<li><strong>Rayonnement</strong> : transfert par ondes electromagnetiques, sans support materiel (ex : rayonnement solaire)</li>'
                    + '<li><strong>Flux thermique</strong> : Phi = Q / Delta(t), en watts (W). Quantite d\'énergie transferee par unite de temps</li>'
                    + '<li><strong>Capacite thermique</strong> : Q = m * c * Delta(T), ou c est la capacité thermique massique (J/(kg.K))</li>'
                    + '</ul>'
                    ...
                    + '<li><strong>Chaine energetique</strong> : diagramme representant les conversions et transferts d\'énergie dans un système</li>'
                    + '<li><strong>Sources d\'énergie</strong> : renouvelables (solaire, eolien, hydraulique) et non renouvelables (fossiles, nucleaire)</li>'
                    + '</ul>',
                flashcards: [
                    { question: 'C\'est quoi le 1er principe de la thermodynamique ?', answer: 'Formule : Delta(U) = W + Q. En gros : l\'énergie d\'un système change quand on lui donne du travail (W) ou de la chaleur (Q). Exemple : tu chauffes de l\'eau (Q = chaleur) et tu la remues (W = travail). L\'eau gagne de l\'énergie. Mots difficiles : "thermodynamique" = la science de la chaleur et de l\'énergie. "énergie interne" = l\'énergie cachee dans la matière (vibrations des atomes).' },
                    { question: 'Quels sont les 3 types de transfert de chaleur ?', answer: '1) CONDUCTION = la chaleur passe par CONTACT. Ex : toucher une poele chaude. 2) CONVECTION = la chaleur se deplace avec un liquide ou un gaz. Ex : l\'eau chaude qui monte dans une casserole. 3) RAYONNEMENT = la chaleur voyage par ondes (sans toucher). Ex : le soleil qui te rechauffe. En gros : contact, deplacement de matière, ou ondes.' },
                    { question: 'C\'est quoi la formule Q = m x c x Delta(T) ?', answer: 'Q = chaleur. m = masse. c = capacité thermique (un nombre qui depend du materiau). Delta(T) = changement de temperature. En gros : pour chauffer quelque chose, il faut de l\'énergie. Plus c\'est lourd et plus tu veux chauffer fort, plus il faut d\'énergie. Exemple : chauffer 1L d\'eau de 20 a 100 degres demande beaucoup d\'énergie car l\'eau à un c très élève (4180).' },
                    { question: 'C\'est quoi le rendement ?', answer: 'Formule : rendement = énergie utile / énergie totale. En gros : c\'est le pourcentage d\'énergie qui sert VRAIMENT. Le reste est perdu (en chaleur, frottements...). Exemple : une ampoule classique à un rendement de 5%. Sur 100 unites d\'électricité, seulement 5 deviennent de la lumiere. Les 95 autres deviennent de la chaleur perdue. Un rendement de 100% est impossible.' },
                    { question: 'C\'est quoi un flux thermique ?', answer: 'Formule : Phi = Q / t. En gros : c\'est la VITESSE a laquelle la chaleur se deplace. Unite = watt (W). Exemple : un radiateur de 1000 W envoie 1000 joules de chaleur chaque seconde. Plus le flux est grand, plus ca chauffe vite. Mots difficiles : "flux" = quantité qui passe par unite de temps (comme un debit d\'eau).' },
                    { question: 'C\'est quoi la conservation de l\'énergie ?', answer: 'L\'énergie ne se CREE pas. L\'énergie ne se DETRUIT pas. Elle se TRANSFORME. En gros : l\'énergie change de forme mais le total reste toujours le meme. Exemple : dans une voiture, l\'essence (énergie chimique) devient mouvement (énergie cinetique) + chaleur (énergie thermique). Rien n\'est perdu, tout est transforme. C\'est LA loi la plus importante de la physique.' },
                    { question: 'C\'est quoi la capacité thermique massique ?', answer: 'C\'est le "c" dans Q = m x c x Delta(T). Ca représenté a quel point un materiau est DIFFICILE a chauffer. En gros : plus c est grand, plus il faut d\'énergie pour chauffer. L\'eau à un c très élève (4180) = elle met longtemps a chauffer et longtemps a refroidir. Le metal à un c faible = il chauffe vite et refroidit vite. C\'est pour ca qu\'une poele brule et que la mer reste tiede.' },
                    { question: 'C\'est quoi la difference entre énergie et puissance ?', answer: 'Energie = la quantité TOTALE (en joules). Puissance = la VITESSE a laquelle on utilise l\'énergie (en watts). Formule : Puissance = Energie / Temps. En gros : l\'énergie c\'est COMBIEN, la puissance c\'est A QUELLE VITESSE. Exemple : 2 coureurs montent le même escalier. Ils depensent la même énergie. Mais celui qui va plus vite a plus de puissance.' },
                    { question: 'Qu\'est-ce qu\'une chaine energetique ?', answer: 'Un diagramme qui représenté les conversions d\'énergie dans un système : on y indique les reservoirs, les convertisseurs, les formes d\'énergie utile et les pertes (souvent thermiques).' },
                    { question: 'Citer les principales formes d\'énergie.', answer: 'Cinetique (mouvement), potentielle (position), thermique (temperature), electrique, chimique (liaisons), nucleaire (noyaux), rayonnante (photons).' },
                    { question: 'Quelle est l\'unite SI de l\'énergie ?', answer: 'Le joule (J). Autres unites courantes : kilowattheure (1 kWh = 3,6 * 10^6 J), calorie (1 cal = 4,18 J), electronvolt (1 eV = 1,6 * 10^-19 J).' },
                ...
                quiz: [
                    { question: 'Le premier principe de la thermodynamique s\'ecrit :', options: ['Delta(U) = W + Q', 'Delta(U) = W - Q', 'Delta(U) = W * Q', 'Delta(U) = Q / W'], correctIndex: 0, explanation: 'Delta(U) = W + Q : la variation d\'énergie interne est la somme du travail et de la chaleur recus.' },
                    { question: 'Le transfert thermique par rayonnement :', options: ['Necessite un milieu materiel', 'Ne nécessité pas de milieu materiel', 'N\'existe que dans les solides', 'Est toujours negligeable'], correctIndex: 1, explanation: 'Le rayonnement se propage par ondes electromagnetiques et ne nécessité pas de support materiel (il traverse le vide).' },
                    { question: 'Pour chauffer 2 kg d\'eau de 20 degres C (c = 4180 J/(kg.K)), l\'énergie necessaire est :', options: ['83 600 J', '167 200 J', '8 360 J', '41 800 J'], correctIndex: 1, explanation: 'Q = m*c*Delta(T) = 2 * 4180 * 20 = 167 200 J.' },
                    ...
                    { question: 'La puissance est definie par :', options: ['P = E * t', 'P = E / t', 'P = E + t', 'P = E - t'], correctIndex: 1, explanation: 'La puissance est le rapport entre l\'énergie et le temps : P = E / t, en watts (W).' },
                    ...
                    { question: 'Le transfert thermique par convection concerne :', options: ['Les solides uniquement', 'Les fluides (liquides et gaz)', 'Le vide', 'Les ondes electromagnetiques'], correctIndex: 1, explanation: 'La convection implique un deplacement de matière et ne concerne donc que les fluides.' },
                    { question: 'L\'unite SI de la capacité thermique massique est :', options: ['J/kg', 'J/(kg.K)', 'W/(m.K)', 'J/K'], correctIndex: 1, explanation: 'La capacité thermique massique c s\'exprime en joules par kilogramme par kelvin : J/(kg.K).' },
                    { question: 'L\'énergie totale d\'un système isole :', options: ['Augmente toujours', 'Diminue toujours', 'Reste constante', 'Depend de la temperature'], correctIndex: 2, explanation: 'Principe de conservation de l\'énergie : dans un système isole, l\'énergie totale est constante.' },
                    { question: 'Le flux thermique Phi s\'exprime en :', options: ['Joules', 'Watts', 'Kelvins', 'Joules par kelvin'], correctIndex: 1, explanation: 'Phi = Q / Delta(t) est en watts (W), car c\'est une puissance thermique (énergie par unite de temps).' },
                    { question: 'Un système recoit un travail W = 200 J et cede une chaleur Q = -50 J. La variation de son énergie interne est :', options: ['250 J', '150 J', '-150 J', '100 J'], correctIndex: 1, explanation: 'Delta(U) = W + Q = 200 + (-50) = 150 J. Le système recoit du travail (W > 0) et cede de la chaleur (Q < 0).' },
                    { question: 'La resistance thermique d\'une paroi augmente quand :', options: ['La conductivite thermique augmente', 'L\'epaisseur de la paroi augmente', 'La surface de la paroi augmente', 'La temperature augmente'], correctIndex: 1, explanation: 'Rth = e / (lambda * S). La resistance thermique augmente avec l\'epaisseur e et diminue avec la conductivite lambda et la surface S. Un bon isolant à une grande Rth.' }
                ]
            },
            {
                id: 'ondes',
                ...
                content: '<h3>Caracteristiques des ondes</h3>'
                    + '<ul>'
                    + '<li><strong>Onde mecanique</strong> : perturbation qui se propage dans un milieu materiel sans transport de matière (son, vague, seisme)</li>'
                    + '<li><strong>Onde electromagnetique</strong> : se propage dans le vide et la matière (lumiere, radio, rayons X)</li>'
                    ...
                    + '<li><strong>Ondes transversales</strong> : perturbation perpendiculaire à la propagation (corde, lumiere). <strong>Ondes longitudinales</strong> : perturbation parallele (son)</li>'
                    + '</ul>'
                ...
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce que la diffraction ?', answer: 'Phenomene de deviation d\'une onde lorsqu\'elle rencontre un obstacle ou une ouverture dont la taille est du même ordre de grandeur que sa longueur d\'onde. L\'angle de diffraction est theta = lambda / a.' },
                    ...
                    { question: 'Quelle est la difference entre onde transversale et onde longitudinale ?', answer: 'Transversale : la perturbation est perpendiculaire à la direction de propagation (corde, lumiere). Longitudinale : la perturbation est parallele à la propagation (son).' },
                    { question: 'Quelle est la celerite de la lumière dans le vide ?', answer: 'c = 3,00 * 10^8 m/s (exactement 299 792 458 m/s). C\'est aussi la vitesse maximale dans l\'univers selon la relativite restreinte.' },
                    ...
                    { question: 'Comment varie l\'angle de diffraction avec la longueur d\'onde ?', answer: 'theta = lambda / a. Plus lambda est grand (ou a petit), plus l\'angle de diffraction est grand. La diffraction est significative quand lambda est du même ordre que a.' },
                    { question: 'Qu\'est-ce qu\'une onde monochromatique ?', answer: 'Une onde de frequence unique (une seule longueur d\'onde). Un laser emet de la lumière quasi monochromatique. La lumière blanche est polychromatique.' },
                    { question: 'Qu\'est-ce que la difference de marche ?', answer: 'delta = d2 - d1, la difference de distance parcourue par deux ondes issues de sources coherentes pour arriver au même point. Elle determine le type d\'interference.' },
                    { question: 'Quel est le domaine de longueurs d\'onde de la lumière visible ?', answer: 'De 400 nm (violet) a 800 nm (rouge) environ. En dessous : ultraviolet, rayons X, gamma. Au-dessus : infrarouge, micro-ondes, ondes radio.' },
                    { question: 'Qu\'est-ce que le decalage vers le rouge en astrophysique ?', answer: 'Un effet Doppler : les galaxies qui s\'eloignent emettent une lumière dont la longueur d\'onde percue est plus grande (decalee vers le rouge). Cela prouve l\'expansion de l\'univers.' },
                    { question: 'Comment calculer la frequence d\'une onde connaissant lambda et v ?', answer: 'f = v / lambda. Exemple : une onde sonore de lambda = 0,5 m dans l\'air (v = 340 m/s) à une frequence f = 340/0,5 = 680 Hz.' }
                ],
                quiz: [
                    ...
                    { question: 'La diffraction est significative quand :', options: ['lambda >> a', 'lambda << a', 'lambda est du même ordre que a', 'lambda = 0'], correctIndex: 2, explanation: 'La diffraction est observable quand la longueur d\'onde est du même ordre de grandeur que la taille de l\'obstacle ou de l\'ouverture.' },
                    ...
                    { question: 'La celerite de la lumière dans le vide est :', options: ['340 m/s', '3 * 10^8 m/s', '3 * 10^6 m/s', '1500 m/s'], correctIndex: 1, explanation: 'c = 3,00 * 10^8 m/s est la vitesse de la lumière dans le vide.' },
                    ...
                    { question: 'Le son est une onde :', options: ['Transversale', 'Longitudinale', 'Electromagnetique', 'Stationnaire uniquement'], correctIndex: 1, explanation: 'Le son est une onde mecanique longitudinale : la perturbation (compression/dilatation) est parallele à la propagation.' },
                    { question: 'La lumière visible à une longueur d\'onde comprise entre :', options: ['1 nm et 100 nm', '400 nm et 800 nm', '1 mm et 1 m', '100 m et 1 km'], correctIndex: 1, explanation: 'Le spectre visible s\'etend approximativement de 400 nm (violet) a 800 nm (rouge).' },
                    ...
                    { question: 'Deux ondes coherentes de même amplitude interfèrent destructivement. L\'amplitude resultante est :', options: ['Doublee', 'Nulle', 'Inchangee', 'Triplee'], correctIndex: 1, explanation: 'En interference destructive, les deux ondes sont en opposition de phase et s\'annulent : l\'amplitude resultante est nulle.' },
                    ...
                    { question: 'Le niveau d\'intensite sonore L (en dB) est defini par :', options: ['L = 10 * log(I / I0)', 'L = 20 * log(I / I0)', 'L = I / I0', 'L = ln(I / I0)'], correctIndex: 0, explanation: 'L = 10 * log(I / I0), ou I0 = 10^-12 W/m^2 est le seuil d\'audibilite. Le logarithme est en base 10. Une augmentation de 10 dB correspond à une intensite multipliee par 10.' }
                ]
            },
            {
                id: 'optique',
                ...
                content: '<h3>Lois de Snell-Descartes</h3>'
                    ...
                    + '<li><strong>Refraction</strong> : n1 * sin(i1) = n2 * sin(i2). Le rayon refracte change de direction en passant d\'un milieu à un autre</li>'
                    ...
                    + '<ul>'
                    + '<li><strong>Spectre lumineux</strong> : decomposition de la lumière par un prisme ou un reseau. Spectre continu (corps chaud), spectre de raies (emission/absorption d\'atomes)</li>'
                    + '<li><strong>Dualite onde-corpuscule</strong> : la lumière se comporte comme une onde (diffraction, interferences) et comme un flux de particules (photons)</li>'
                    ...
                    + '</ul>',
                flashcards: [
                    { question: 'Enoncer la loi de Snell-Descartes pour la refraction.', answer: 'n1 * sin(i1) = n2 * sin(i2), ou n1 et n2 sont les indices de refraction des deux milieux, i1 l\'angle d\'incidence et i2 l\'angle de refraction (mesures par rapport à la normale).' },
                    { question: 'Qu\'est-ce que l\'indice de refraction d\'un milieu ?', answer: 'n = c / v, ou c = 3 * 10^8 m/s (vitesse de la lumière dans le vide) et v la vitesse dans le milieu. n est toujours >= 1. Exemples : n_air = 1,00 ; n_eau = 1,33 ; n_verre = 1,5.' },
                    { question: 'Qu\'est-ce que la reflexion totale ?', answer: 'Quand la lumière passe d\'un milieu plus refringent (n1 > n2) à un milieu moins refringent, au-dela de l\'angle limite i_lim (sin(i_lim) = n2/n1), toute la lumière est reflechie. Principe de la fibre optique.' },
                    ...
                    { question: 'Quelle est l\'énergie d\'un photon ?', answer: 'E = h * f = h * c / lambda, ou h = 6,63 * 10^-34 J.s est la constante de Planck, f la frequence (Hz), lambda la longueur d\'onde (m).' },
                    { question: 'Qu\'est-ce que la dualite onde-corpuscule ?', answer: 'La lumière presente un double comportement : ondulatoire (diffraction, interferences) et corpusculaire (effet photoelectrique, photons). De Broglie a etendu ce concept a toute particule materielle.' },
                    { question: 'Quelle est la longueur d\'onde de de Broglie ?', answer: 'lambda = h / (m * v) = h / p, ou h est la constante de Planck, m la masse et v la vitesse de la particule, p sa quantité de mouvement.' },
                    { question: 'Comment un prisme decompose-t-il la lumière blanche ?', answer: 'Par dispersion : l\'indice de refraction du prisme depend de la longueur d\'onde (n plus grand pour le violet que pour le rouge). Chaque couleur est deviee differemment, formant un spectre.' },
                    { question: 'Qu\'est-ce qu\'un spectre d\'emission de raies ?', answer: 'Spectre produit par un gaz a basse pression excite. Il ne contient que des raies discretes correspondant aux transitions electroniques de l\'atome. Chaque element à un spectre unique.' },
                    { question: 'Qu\'est-ce qu\'un spectre d\'absorption ?', answer: 'Spectre continu dans lequel apparaissent des raies sombres. La lumière blanche traverse un gaz froid qui absorbe certaines longueurs d\'onde correspondant a ses transitions electroniques.' },
                    ...
                    { question: 'Comment tracer les rayons principaux pour une lentille convergente ?', answer: '1) Rayon parallele a l\'axe passe par F\' après la lentille. 2) Rayon passant par le centre O n\'est pas devie. 3) Rayon passant par F ressort parallele a l\'axe.' },
                    { question: 'Quelle est la loi de la reflexion ?', answer: 'Le rayon reflechi est dans le plan d\'incidence, et l\'angle de reflexion est egal a l\'angle d\'incidence : i_r = i_1. Le rayon reflechi est symetrique du rayon incident par rapport à la normale.' }
                ],
                quiz: [
                    ...
                    { question: 'L\'énergie d\'un photon de frequence f vaut :', options: ['E = m*c^2', 'E = h*f', 'E = (1/2)*m*v^2', 'E = k*T'], correctIndex: 1, explanation: 'E = h*f ou E = h*c/lambda, avec h = 6,63 * 10^-34 J.s (constante de Planck).' },
                    { question: 'La reflexion totale se produit quand :', options: ['n1 < n2 et i1 > i_lim', 'n1 > n2 et i1 > i_lim', 'n1 = n2', 'i1 = 0'], correctIndex: 1, explanation: 'La reflexion totale ne peut se produire que lorsque la lumière passe d\'un milieu plus refringent à un milieu moins refringent (n1 > n2), pour un angle superieur a l\'angle limite.' },
                    ...
                    { question: 'Un grandissement gamma = -2 signifie :', options: ['Image 2 fois plus petite et droite', 'Image 2 fois plus grande et renversee', 'Image de même taille et renversee', 'Image 2 fois plus grande et droite'], correctIndex: 1, explanation: 'gamma = -2 : |gamma| = 2 donc l\'image est 2 fois plus grande, et le signe negatif indique qu\'elle est renversee.' },
                    ...
                    { question: 'Un photon violet a plus d\'énergie qu\'un photon rouge car :', options: ['Sa longueur d\'onde est plus grande', 'Sa frequence est plus grande', 'Sa vitesse est plus grande', 'Sa masse est plus grande'], correctIndex: 1, explanation: 'E = h*f. Le violet à une frequence plus grande (lambda plus petit), donc une énergie plus grande. La vitesse de la lumière est la même pour toutes les couleurs dans le vide.' },
                    ...
                    { question: 'Un spectre d\'absorption presente :', options: ['Des raies brillantes sur fond noir', 'Des raies sombres sur fond continu', 'Un spectre continu sans raies', 'Uniquement du rouge et du bleu'], correctIndex: 1, explanation: 'Le gaz froid absorbe certaines longueurs d\'onde de la lumière blanche, creant des raies noires dans le spectre continu.' },
            ...
            },
            {
                ...
                content: '<h3>Alcanes, alcenes et groupes fonctionnels</h3>'
                    ...
                    + '<ul>'
                    + '<li><strong>Isomerie de constitution</strong> : même formule brute mais enchainements differents (chaine, position, fonction)</li>'
                    + '<li><strong>Stereoisomerie Z/E</strong> : autour d\'une double liaison C=C, les substituants peuvent etre du même cote (Z) ou de cotes opposes (E)</li>'
                ...
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce que l\'isomerie de constitution ?', answer: 'Des molecules ayant la même formule brute mais des enchainements d\'atomes differents. Trois types : isomerie de chaine (squelette different), de position (meme groupe fonctionnel a des positions differentes), de fonction (groupes fonctionnels differents).' },
                    { question: 'Qu\'est-ce que la stereoisomerie Z/E ?', answer: 'Isomerie liee à une double liaison C=C. Z (zusammen) : les groupes prioritaires sont du même cote de la double liaison. E (entgegen) : ils sont de cotes opposes. Regles de priorite de Cahn-Ingold-Prelog.' },
                    ...
                    { question: 'Quelle est la difference entre un aldehyde et une cetone ?', answer: 'Les deux contiennent le groupe carbonyle C=O. L\'aldehyde a le C=O en bout de chaine (lie à un H), la cetone l\'a au milieu de la chaine (lie a deux C). Suffixes : -al et -one.' },
                    ...
                    { question: 'Qu\'est-ce que des enantiomeres ?', answer: 'Deux molecules images l\'une de l\'autre dans un miroir, non superposables. Elles ont les memes proprietes physiques sauf l\'activité optique (rotation du plan de polarisation en sens oppose). Configurations R et S.' },
                ...
                quiz: [
                    ...
                    { question: 'Le suffixe -ol indique la presence de :', options: ['Un groupe carbonyle', 'Un groupe hydroxyle', 'Un groupe amine', 'Un groupe carboxyle'], correctIndex: 1, explanation: 'Le suffixe -ol correspond à la famille des alcools, qui possedent le groupe hydroxyle -OH.' },
                    { question: 'Deux isomeres de constitution ont :', options: ['La même formule developpee', 'La même formule brute mais des enchainements differents', 'Des formules brutes differentes', 'Toujours la même fonction chimique'], correctIndex: 1, explanation: 'Les isomeres de constitution partagent la même formule brute mais different par l\'enchainement des atomes.' },
            ...
            },
            {
                ...
                content: '<h3>pH et couples acide/base</h3>'
                    ...
                    + '<li><strong>Acide fort</strong> : reaction totale avec l\'eau (Ka très grand, pKa < 0). Ex : HCl, HNO3, H2SO4</li>'
                    ...
                    + '<li><strong>Point d\'equivalence</strong> : repère par un indicateur colore, un saut de pH, ou par conductimetrie</li>'
                    + '<li><strong>Relation a l\'equivalence</strong> : Ca * Va = Cb * Vb (pour monoacide/monobase)</li>'
                    + '<li><strong>Solution tampon</strong> : mélange acide faible / base conjuguee en proportions voisines. Le pH varie peu lors d\'ajouts moderes d\'acide ou de base. pH = pKa + log([A-]/[AH])</li>'
                    + '</ul>',
                flashcards: [
                    { question: 'Donner la definition d\'un acide selon Bronsted.', answer: 'Un acide est une espece chimique capable de ceder (donner) un proton H+ à une autre espece chimique. Exemple : HCl -> H+ + Cl-.' },
                    ...
                    { question: 'Qu\'est-ce qu\'une solution tampon ?', answer: 'Un mélange d\'un acide faible et de sa base conjuguee en proportions comparables. Son pH varie peu lors de l\'ajout modere d\'acide ou de base, ou lors d\'une dilution. pH = pKa + log([A-]/[AH]) (formule de Henderson-Hasselbalch).' },
                ...
                quiz: [
                    ...
                    { question: 'Un acide de pKa = 2 est :', options: ['Un acide faible', 'Un acide relativement fort', 'Une base', 'Neutre'], correctIndex: 1, explanation: 'Plus le pKa est bas, plus l\'acide est fort. Un pKa de 2 correspond à un acide assez fort (mais pas totalement dissocies comme les acides forts avec pKa < 0).' },
                    ...
                    { question: 'Un acide fort est un acide qui :', options: ['Reagit partiellement avec l\'eau', 'Reagit totalement avec l\'eau', 'Ne reagit pas avec l\'eau', 'A un pKa élève'], correctIndex: 1, explanation: 'Un acide fort se dissocie totalement dans l\'eau : AH + H2O -> A- + H3O+ (reaction complete, Ka très grand).' },
                    { question: 'Une solution tampon resiste aux variations de pH car :', options: ['Elle contient un acide fort', 'Elle contient un mélange acide faible / base conjuguee', 'Elle est très diluee', 'Son pH est toujours 7'], correctIndex: 1, explanation: 'La solution tampon contient un reservoir d\'acide faible et de base conjuguee qui neutralisent les ajouts d\'acide ou de base.' },
            ...
            },
            {
                ...
                content: '<h3>Loi d\'Ohm et lois de Kirchhoff</h3>'
                    ...
                    + '<li><strong>Loi des noeuds (Kirchhoff)</strong> : la somme des courants entrant dans un noeud est egale à la somme des courants sortant</li>'
                    ...
                    + '<ul>'
                    + '<li><strong>Condensateur</strong> : stocke de l\'énergie sous forme electrique. Capacite C en farads (F). Q = C * U</li>'
                    ...
                    + '<li><strong>Effet Joule</strong> : toute resistance convertit l\'énergie electrique en chaleur. P_Joule = R * I^2</li>'
                    + '</ul>',
                flashcards: [
                    ...
                    { question: 'Enoncer la loi des noeuds de Kirchhoff.', answer: 'En un noeud d\'un circuit, la somme des intensites des courants entrants est egale à la somme des intensites des courants sortants. C\'est la conservation de la charge electrique.' },
                    { question: 'Enoncer la loi des mailles de Kirchhoff.', answer: 'La somme algebrique des tensions le long d\'une maille fermee est nulle. C\'est une consequence de la conservation de l\'énergie dans le circuit.' },
                    { question: 'Comment calculer la resistance equivalente en serie ?', answer: 'R_eq = R1 + R2 + R3 + ... Les resistances s\'ajoutent en serie. Le courant est le même dans toutes les resistances.' },
                    { question: 'Comment calculer la resistance equivalente en parallele ?', answer: '1/R_eq = 1/R1 + 1/R2 + 1/R3 + ... La resistance equivalente est toujours inferieure à la plus petite resistance. La tension est la même aux bornes de chaque resistance.' },
                    { question: 'Quelle est la relation charge-tension d\'un condensateur ?', answer: 'Q = C * U, ou Q est la charge (en coulombs C), C la capacité (en farads F), U la tension (en volts V).' },
                    { question: 'Quelle est l\'énergie stockee dans un condensateur ?', answer: 'E = (1/2) * C * U^2 = (1/2) * Q * U = Q^2 / (2*C). L\'énergie est en joules.' },
                    ...
                    { question: 'Qu\'est-ce que l\'effet Joule ?', answer: 'Tout conducteur ohmique parcouru par un courant dissipe de l\'énergie sous forme de chaleur. La puissance dissipee est P = R * I^2. C\'est un phénomène irreversible.' },
                    { question: 'Quelle est la formule de l\'énergie electrique ?', answer: 'E = P * t = U * I * t, en joules (J). Pratiquement, on utilise le kWh : 1 kWh = 3,6 * 10^6 J.' },
                ...
                quiz: [
                    ...
                    { question: 'L\'énergie stockee dans un condensateur de 10 microF sous 100 V est :', options: ['0,05 J', '0,5 J', '5 J', '50 J'], correctIndex: 0, explanation: 'E = (1/2)*C*U^2 = (1/2) * 10*10^-6 * 100^2 = (1/2) * 10^-5 * 10^4 = 0,05 J.' },
                    ...
                    { question: 'La loi des noeuds traduit la conservation :', options: ['De l\'énergie', 'De la charge electrique', 'De la masse', 'De la tension'], correctIndex: 1, explanation: 'La loi des noeuds exprime que la charge electrique est conservee : tout le courant entrant dans un noeud en ressort.' },
                    { question: 'La loi des mailles stipule que dans une maille fermee :', options: ['La somme des courants est nulle', 'La somme des tensions est nulle', 'La somme des resistances est nulle', 'La somme des puissances est nulle'], correctIndex: 1, explanation: 'La somme algebrique des tensions le long d\'une maille fermee est nulle (conservation de l\'énergie).' },
                    ...
                    { question: 'L\'effet Joule dans un conducteur ohmique produit :', options: ['De la lumiere', 'De la chaleur', 'Un champ magnetique uniquement', 'Du mouvement'], correctIndex: 1, explanation: 'L\'effet Joule est la conversion irreversible de l\'énergie electrique en énergie thermique (chaleur) dans une resistance.' },
                    { question: 'Un generateur de f.e.m. E = 12 V et de resistance interne r = 2 ohms alimente une resistance R = 4 ohms. L\'intensite du courant est :', options: ['2 A', '3 A', '6 A', '1 A'], correctIndex: 0, explanation: 'Loi d\'Ohm pour le circuit complet : I = E / (R + r) = 12 / (4 + 2) = 12 / 6 = 2 A. La resistance interne du generateur s\'ajoute à la resistance externe.' },
                    { question: 'Dans un circuit RC, après un temps egal à une constante de temps tau, la tension du condensateur en charge atteint environ :', options: ['37% de E', '50% de E', '63% de E', '86% de E'], correctIndex: 2, explanation: 'U_C(tau) = E * (1 - e^(-1)) = E * (1 - 0,37) = 0,63 * E, soit environ 63% de la tension finale E.' }
                ]
            },
            {
                id: 'nucleaire',
                ...
                content: '<h3>Noyau atomique et radioactivite</h3>'
                    ...
                    + '<li><strong>Isotopes</strong> : même Z (meme element) mais A different (nombre de neutrons different). Ex : carbone-12 et carbone-14</li>'
                    ...
                    + '</ul>'
                    + '<h3>Fission, fusion et equivalence masse-énergie</h3>'
                    + '<ul>'
                    + '<li><strong>Defaut de masse</strong> : Delta(m) = Z*mp + (A-Z)*mn - m_noyau > 0. La masse du noyau est inferieure à la somme des masses des nucleons separes</li>'
                    + '<li><strong>Energie de liaison</strong> : E_l = Delta(m) * c^2. Plus E_l/A est grande, plus le noyau est stable (maximum : fer-56)</li>'
                    + '<li><strong>Equivalence masse-énergie (Einstein)</strong> : E = m * c^2. 1 u = 931,5 MeV/c^2</li>'
                    + '<li><strong>Fission</strong> : un noyau lourd se scinde en deux noyaux plus legers + neutrons + énergie. Ex : uranium-235 dans les centrales nucleaires</li>'
                    + '<li><strong>Fusion</strong> : deux noyaux legers fusionnent en un noyau plus lourd + énergie. Ex : fusion de l\'hydrogene dans les etoiles</li>'
                    + '</ul>',
                flashcards: [
                    ...
                    { question: 'Qu\'est-ce que la radioactivite beta- ?', answer: 'Un neutron du noyau se transforme en proton avec emission d\'un electron (0/-1 e) et d\'un antineutrino. Z augmente de 1, A reste constant. Le noyau fils à un proton de plus.' },
                    { question: 'C\'est quoi la radioactivite gamma ?', answer: 'Un noyau trop "excite" (= trop d\'énergie) se calme en envoyant un flash de lumière invisible très puissant (= rayon gamma). Le noyau ne change PAS. Il se debarrasse juste de l\'énergie en trop. Imagine une bouilloire qui siffle : elle evacue la vapeur. Le rayon gamma, c\'est la "vapeur" du noyau. Mots difficiles : "photon gamma" = grain de lumière invisible mais ultra-energetique. "desexcitation" = retour au calme.' },
                    ...
                    { question: 'C\'est quoi E = mc^2 ?', answer: 'La formule la plus celebre du monde, par Einstein. Elle dit : la masse, c\'est de l\'énergie compactee. Meme un tout petit bout de matière contient une énergie ENORME (parce que c = vitesse de la lumière = très tres grand, et c^2 = encore plus grand). Exemple : 1 gramme de matière contient autant d\'énergie qu\'une bombe. C\'est le principe de l\'énergie nucleaire. Mots difficiles : "c" = vitesse de la lumière = 300 000 km/s. "equivalence masse-énergie" = masse et énergie, c\'est la même chose sous deux formes.' },
                    { question: 'C\'est quoi le defaut de masse ?', answer: 'Imagine des LEGO separes. Tu les assembles pour faire un noyau. Le noyau assemble pese MOINS que tous les LEGO separes. La masse qui "manque" s\'est transformee en ENERGIE (via E = mc^2). C\'est cette énergie qui COLLE les protons et neutrons ensemble dans le noyau. En gros : assembler un noyau fait perdre un peu de masse, et cette masse perdue devient l\'énergie qui tient le tout. Mots difficiles : "nucleons" = les briques du noyau (protons + neutrons). "énergie de liaison" = l\'énergie qui colle les nucleons ensemble.' },
                    { question: 'C\'est quoi l\'énergie de liaison par nucleon ?', answer: 'C\'est l\'énergie de liaison divisee par le nombre de briques (nucleons). Plus ce chiffre est GRAND, plus le noyau est SOLIDE. Le noyau le plus solide = le fer. En gros : c\'est comme la qualité de la colle par brique de LEGO. Le fer à la meilleure colle. Les noyaux très lourds (uranium) et très legers (hydrogene) ont une colle plus faible.' },
                    { question: 'C\'est quoi la fission nucleaire ?', answer: 'On CASSE un gros noyau (ex : uranium) en deux morceaux plus petits. Ca libere une ENORME quantité d\'énergie. C\'est comme ca que marchent les centrales nucleaires. Imagine une grosse boule de LEGO mal collee : tu la casses et les morceaux partent a toute vitesse. Cette vitesse = l\'énergie. Mots difficiles : "fission" = casser en deux (du latin "fissio" = coupure). "uranium-235" = un atome très lourd utilise dans les centrales.' },
                    { question: 'C\'est quoi la fusion nucleaire ?', answer: 'On COLLE deux petits noyaux ensemble pour en faire un plus gros. Ca libere encore PLUS d\'énergie que la fission. C\'est comme ca que le soleil fonctionne. Probleme : il faut des temperatures de millions de degres pour y arriver. On n\'a pas encore reussi a le faire sur Terre de manière rentable. Mots difficiles : "fusion" = fusionner, coller ensemble. "deuterium/tritium" = des types d\'hydrogene très legers.' },
                    { question: 'C\'est quoi l\'activité radioactive ?', answer: 'C\'est le nombre de noyaux qui se desintegrent CHAQUE SECONDE. Unite = becquerel (Bq). 1 Bq = 1 desintegration par seconde. Plus l\'activité est forte, plus c\'est radioactif (= plus c\'est dangereux). L\'activité diminue avec le temps (car il reste de moins en moins de noyaux a desintegrer). Mots difficiles : "becquerel" = unite d\'activité, du nom du physicien qui a decouvert la radioactivite.' },
                    { question: 'C\'est quoi des isotopes ?', answer: 'Ce sont des atomes du MEME element mais avec un nombre de neutrons different. Ils ont les memes proprietes chimiques mais pas le même poids. Exemple : l\'hydrogene a 3 isotopes. H-1 (normal, 0 neutron). H-2 (deuterium, 1 neutron). H-3 (tritium, 2 neutrons). Tous sont de l\'hydrogene, mais le tritium est radioactif. Mots difficiles : "isotope" = du grec "isos" (meme) + "topos" (place) = même place dans le tableau periodique.' },
                    { question: 'Comment marche la datation au carbone 14 ?', answer: 'Quand un etre vivant est VIVANT, il absorbe du carbone 14 (radioactif) en permanence. Quand il MEURT, il arrete d\'en absorber. Le carbone 14 se desintegre petit a petit (demi-vie = 5730 ans). En mesurant combien il en reste, on calcule depuis combien de temps il est mort. Exemple : un os qui a perdu la moitie de son C-14 est mort il y a 5730 ans. En gros : c\'est une horloge naturelle qui demarre à la mort.' },
                    { question: 'Pourquoi fission ET fusion liberent de l\'énergie ?', answer: 'Parce que les deux vont vers des noyaux PLUS STABLES (= mieux colles). Le fer est le noyau le plus stable. Les noyaux trop LOURDS (uranium) veulent devenir plus legers → fission. Les noyaux trop LEGERS (hydrogene) veulent devenir plus lourds → fusion. Les deux vont vers le fer = les deux liberent de l\'énergie. Imagine une vallee : le fer est en bas. Que tu viennes de la gauche (fusion) ou de la droite (fission), tu descends = tu liberes de l\'énergie.' }
                ],
                quiz: [
                    { question: 'Dans la notation A/Z X, A représenté :', options: ['Le nombre de protons', 'Le nombre de masse (protons + neutrons)', 'Le nombre d\'electrons', 'Le nombre de neutrons'], correctIndex: 1, explanation: 'A = nombre de masse = nombre de protons (Z) + nombre de neutrons (N). A = Z + N.' },
                    ...
                    { question: 'L\'equivalence masse-énergie d\'Einstein est :', options: ['E = m*v^2', 'E = m*c', 'E = m*c^2', 'E = (1/2)*m*c^2'], correctIndex: 2, explanation: 'E = m*c^2, ou c = 3 * 10^8 m/s. Une petite masse correspond à une enorme énergie.' },
                    { question: 'La fission nucleaire concerne :', options: ['La fusion de noyaux legers', 'La cassure de noyaux lourds', 'L\'emission de photons', 'La desintegration beta'], correctIndex: 1, explanation: 'La fission est la cassure (scission) d\'un noyau lourd (ex : U-235) en deux noyaux plus legers, avec liberation d\'énergie et de neutrons.' },
                    { question: 'La fusion nucleaire se produit dans :', options: ['Les centrales nucleaires actuelles', 'Les etoiles', 'Les reacteurs a fission', 'Les accelerateurs de particules uniquement'], correctIndex: 1, explanation: 'La fusion de l\'hydrogene en helium est la source d\'énergie des etoiles. Sur Terre, la maitrise de la fusion est encore experimentale (ITER).' },
                    { question: 'L\'unite d\'activité radioactive est :', options: ['Le gray (Gy)', 'Le sievert (Sv)', 'Le becquerel (Bq)', 'Le curie (Ci) uniquement'], correctIndex: 2, explanation: 'L\'activité se mesure en becquerels (Bq). 1 Bq = 1 desintegration par seconde. Le curie est une ancienne unite.' },
                    { question: 'Le noyau le plus stable (E_l/A maximale) est proche de :', options: ['L\'hydrogene', 'Le fer (Fe-56)', 'L\'uranium (U-238)', 'L\'helium (He-4)'], correctIndex: 1, explanation: 'Le fer-56 a l\'énergie de liaison par nucleon la plus elevee (environ 8,8 MeV/nucleon). C\'est le sommet de la courbe d\'Aston.' },
                    ...
                    { question: 'L\'énergie liberee lors d\'une reaction nucleaire provient de :', options: ['La transformation d\'electrons en photons', 'La difference de masse entre reactifs et produits (E = Delta(m)*c^2)', 'L\'absorption de neutrons par le noyau', 'La desexcitation des electrons'], correctIndex: 1, explanation: 'L\'énergie liberee correspond au defaut de masse : les produits sont plus legers que les reactifs, et cette difference de masse est convertie en énergie selon E = Delta(m) * c^2 (relation d\'Einstein).' }
                ]
            }
        ]
    });
