        ...
        sections: [
            {
                ...
                flashcards: [
                    // --- COMPARAISON ---
                    { question: 'Quelle figure ? "La terre est bleue comme une orange." (Eluard, L\'Amour la poesie)', answer: 'COMPARAISON. L\'outil "comme" relie "la terre" (compare) et "une orange" (comparant). Meme si l\'image est surrealiste et absurde, la figure reste une comparaison grace au mot-outil. '
                        + '\uD83D\uDCA1 ASTUCE MEMO : ComPARaison = mot de comPARAison. Tu vois "comme", "tel", "semblable a" ? C\'est une comparaison. Point final. '
                        + 'Eluard dynamite la logique pour liberer la poesie : la beaute nait de l\'inattendu.' },
                    { question: 'Quels sont TOUS les outils de comparaison a connaitre pour le Bac ?', answer: 'Les outils de comparaison : COMME, TEL, TEL QUE, SEMBLABLE A, PAREIL A, AINSI QUE, DE MEME QUE, A L\'IMAGE DE, RESSEMBLER A, PLUS... QUE, MOINS... QUE, AUTANT... QUE. '
                        + '\u26A0\uFE0F PIEGE BAC : Le verbe "ETRE" n\'est PAS un outil ! "Il est un lion" = metaphore. "Il est comme un lion" = comparaison. '
                        + '\uD83D\uDCA1 Fais-toi une fiche avec ces mots-outils — si un seul d\'entre eux est present, c\'est une comparaison.' },
                    { question: 'Quelle figure ? "Mon amour, tu es belle, tu es belle, tes yeux sont des colombes." (Cantique des cantiques)', answer: 'COMPARAISON (grace a "sont... des" ? Non !). En fait, "tes yeux sont des colombes" = METAPHORE. Le verbe "etre" n\'est PAS un outil de comparaison — c\'est un piege classique. '
                        + 'La metaphore est plus forte que la comparaison : elle IDENTIFIE au lieu de rapprocher. Les yeux NE SONT PAS "comme" des colombes, ils SONT des colombes. '
                        + '\uD83E\uDDE0 TRUC : si tu peux ajouter mentalement "comme" pour comprendre l\'image, et que "comme" est absent du texte, c\'est une metaphore.' },
                    { question: 'Analyse la comparaison : "Et, comme un oeil naissant couvert par ses paupieres, / Un pur esprit s\'accroit sous l\'ecorce des pierres." (Nerval)', answer: 'Comparaison complexe : compare = "un pur esprit sous l\'ecorce des pierres", comparant = "un oeil naissant couvert par ses paupieres", outil = "comme". '
                        + 'L\'effet est saisissant : Nerval suggere que la matiere est VIVANTE, qu\'un regard se cache dans la pierre. C\'est le mysticisme romantique. '
                        + '\uD83D\uDCA1 Au Bac, ne te contente JAMAIS de nommer la figure : analyse l\'EFFET. Ici : vision animiste du monde, poesie du mystere.' },
                    { question: 'Quelle figure ? "Ses cheveux, pareils a des serpents dresses, encadraient son visage." (inspire de Meduse)', answer: 'COMPARAISON. L\'outil est "pareils a". Compare = "ses cheveux", comparant = "des serpents dresses". '
                        + 'L\'image est terrifiante et monstrueuse : les cheveux deviennent menace. La comparaison peut etre aussi puissante que la metaphore. '
                        + '\uD83D\uDCA1 N\'oublie pas "pareil a" dans ta liste d\'outils. C\'est un outil moins evident que "comme" mais tout aussi valide.' },
                    // --- METAPHORE ---
                    { question: 'Quelle figure ? "Cette faucille d\'or dans le champ des etoiles." (Hugo, Booz endormi)', answer: 'METAPHORE IN ABSENTIA. Le compare (la lune) n\'est meme pas nomme ! Seul le comparant est present : "faucille d\'or". Le lecteur doit deviner que c\'est la lune. '
                        + 'Hugo ne dit pas "la lune COMME une faucille" : il remplace directement la lune par l\'image. C\'est la metaphore la plus puissante car le mot-outil ET le compare ont disparu. '
                        + '\uD83D\uDCA1 ASTUCE MEMO : METAPHORE = le mot-outil a DISPARU (il s\'est fait la malle !). In absentia = le compare aussi a disparu.' },
                    { question: 'Quelle figure ? "Ma jeunesse ne fut qu\'un tenebreux orage." (Baudelaire, L\'Ennemi)', answer: 'METAPHORE IN PRAESENTIA. Compare = "ma jeunesse", comparant = "un tenebreux orage". Les deux sont presents, mais sans outil. '
                        + 'Le verbe "etre" n\'est PAS un outil : "fut un orage" identifie directement la jeunesse a l\'orage. Baudelaire condense toute une vie de souffrance en une image foudroyante. '
                        + '\u26A0\uFE0F PIEGE BAC : beaucoup d\'eleves disent "comparaison" a cause de "fut". NON ! "Etre" = identite, pas comparaison.' },
                    { question: 'Explique la difference entre metaphore IN PRAESENTIA et IN ABSENTIA, avec exemples.', answer: 'IN PRAESENTIA : le compare et le comparant sont tous les deux presents. "Ma jeunesse [compare] fut un orage [comparant]" — on voit les deux termes. '
                        + 'IN ABSENTIA : le compare a disparu, seul le comparant reste. "Cette faucille d\'or [comparant]" — la lune [compare] n\'est pas nommee. '
                        + '\uD83D\uDCA1 In absentia est plus difficile a reperer et plus puissante : le lecteur doit reconstruire le sens. Au Bac, si tu la reperes, mentionne-le : ca montre un niveau d\'analyse avance.' },
                    { question: 'Quelle figure ? "L\'homme n\'est qu\'un roseau, le plus faible de la nature, mais c\'est un roseau pensant." (Pascal, Pensees)', answer: 'METAPHORE IN PRAESENTIA celebrissime. Compare = "l\'homme", comparant = "un roseau". L\'homme est fragile (roseau) mais sa pensee le rend grand. '
                        + 'L\'oxymore implicite "roseau pensant" cree le choc : la fragilite physique s\'allie a la grandeur intellectuelle. '
                        + '\uD83D\uDCA1 Pascal montre que la puissance des figures vient de la TENSION qu\'elles creent. Retiens cette citation, elle revient constamment au Bac.' },
                    { question: 'Dans le rap, Nekfeu ecrit : "J\'suis un volcan sous la banquise." Quelle figure ?', answer: 'METAPHORE IN PRAESENTIA. Compare = "je", comparant = "un volcan sous la banquise". L\'image exprime une passion ardente cachee sous une apparence froide. '
                        + 'C\'est aussi un OXYMORE implicite (volcan = chaleur vs banquise = froid). Le rap moderne est bourre de metaphores ! '
                        + '\uD83D\uDCA1 Les figures de style ne sont pas reservees aux vieux livres : chaque pub Coca, chaque chanson, chaque discours politique les utilise. Ouvre les yeux !' },
                    // --- METAPHORE FILEE ---
                    { question: 'Quelle figure ? "Ce toit tranquille, ou marchent des colombes, / Entre les pins palpite, entre les tombes ; / Midi le juste y compose de feux / La mer, la mer, toujours recommencee !" (Valery, Le Cimetiere marin)', answer: 'METAPHORE FILEE. La mer est decrite comme un "toit" sur lequel "marchent des colombes" (les voiles des bateaux). L\'image architecturale se deroule sur plusieurs vers. '
                        + 'La metaphore filee tisse un reseau d\'images coherent : chaque mot appartient au meme champ lexical. '
                        + '\uD83D\uDCA1 ASTUCE : si tu reperes un champ lexical qui revient sur 2+ lignes ET qu\'il designe autre chose que son sens litteral, c\'est une metaphore filee.' },
                    { question: 'Identifie la metaphore filee : "Le navire de l\'Etat a quitte le port. Les vagues de la revolte menacent de le faire chavirer. Le capitaine tient la barre."', answer: 'Metaphore filee MARITIME pour decrire la POLITIQUE. Navire = Etat, port = stabilite, vagues = revolte, chavirer = s\'effondrer, capitaine = dirigeant, barre = pouvoir. '
                        + 'Tout le passage file la metaphore du bateau. Chaque element du champ lexical maritime a un equivalent politique. '
                        + '\uD83D\uDCA1 Au Bac, montre que tu decodes CHAQUE element de la metaphore filee. C\'est ce qui rapporte des points : pas juste dire "c\'est une metaphore filee" mais expliquer le reseau d\'images.' },
                    { question: 'Baudelaire, L\'Albatros : "Ce voyageur aile / Qu\'on rend comique et laid / Lui, naguere si beau, qu\'il est comique et laid !" Comment la metaphore filee fonctionne-t-elle dans tout le poeme ?', answer: 'L\'Albatros est une metaphore filee du POETE. L\'oiseau majestueux en vol (= le poete inspire) devient ridicule sur le pont du bateau (= le poete dans la societe). '
                        + 'L\'albatros = le poete, le vol = l\'inspiration, le pont = la realite sociale, les marins moqueurs = les bourgeois. Chaque element a un double sens. '
                        + '\uD83D\uDCA1 C\'est le poeme prefere des correcteurs du Bac pour tester la metaphore filee. Si tu le connais, tu as un avantage enorme.' },
                    // --- PERSONNIFICATION ---
                    { question: 'Quelle figure ? "La rue assourdissante autour de moi hurlait." (Baudelaire, A une passante)', answer: 'PERSONNIFICATION. La rue (objet) "hurlait" : on lui attribue une action humaine. La ville devient un etre vivant, agressif, bruyant. '
                        + 'Baudelaire transforme Paris en monstre sonore pour faire ressentir le choc de la modernite. '
                        + '\uD83D\uDCA1 ASTUCE : si un objet, un animal ou une abstraction fait quelque chose d\'humain (parler, pleurer, danser, hurler), c\'est une personnification.' },
                    { question: 'Quelle figure ? "La mer monte comme une lente armee qui s\'eveille." Attention, il y en a deux !', answer: 'COMPARAISON (outil : "comme") + PERSONNIFICATION (la mer = "armee qui s\'eveille", traits humains/militaires). '
                        + 'La mer est comparee a une armee qui s\'eveille : image de puissance, de menace lente et inexorable. '
                        + '\u26A0\uFE0F Au Bac, repere TOUTES les figures dans un extrait. Un passage peut en combiner 2, 3 ou plus. Les correcteurs adorent les eleves qui en reperent plusieurs.' },
                    { question: 'Quelle difference entre personnification et allegorie ? Illustre avec des exemples.', answer: 'PERSONNIFICATION : donner des traits humains a un objet CONCRET. "Le vent gemit" = le vent (concret) fait une action humaine. '
                        + 'ALLEGORIE : representer une idee ABSTRAITE sous forme concrete/humaine. "La Mort, vetue de noir, frappait aux portes" = la mort (abstraite) a une forme humaine. '
                        + '\uD83D\uDCA1 ASTUCE : si c\'est une idee ABSTRAITE avec majuscule (Mort, Justice, Liberte, Amour) qui agit comme un humain = allegorie. Si c\'est un truc concret (arbre, mer, vent) qui agit humainement = personnification.' },
                    // --- ALLEGORIE ---
                    { question: 'Quelle figure ? "La Liberte guidant le peuple" (Delacroix) — une femme brandissant le drapeau sur les barricades.', answer: 'ALLEGORIE. La Liberte (idee abstraite) est representee sous les traits d\'une femme concrete. L\'allegorie rend VISIBLE ce qui est INVISIBLE. '
                        + 'Autres allegories celebres : la Justice (femme aux yeux bandes + balance + glaive), la Mort (squelette + faux), Marianne (la Republique). '
                        + '\uD83D\uDCA1 L\'allegorie est partout : les statues, les logos, les publicites. La statue de la Liberte a New York EST une allegorie de 93 metres de haut.' },
                    { question: 'Quelle figure ? "O Mort, vieux capitaine, il est temps ! levons l\'ancre ! / Ce pays nous ennuie, o Mort ! Appareillons !" (Baudelaire, Le Voyage)', answer: 'C\'est une ALLEGORIE (la Mort = vieux capitaine), une PROSOPOPEE (le poete S\'ADRESSE a la Mort), et une METAPHORE FILEE (le voyage maritime : capitaine, ancre, appareillons). '
                        + 'Derniers vers des Fleurs du mal : Baudelaire accueille la mort comme une aventure ultime. C\'est sublime et terrifiant. '
                        + '\uD83D\uDCA1 Ce passage cumule 3 figures. Au Bac, un passage riche = plusieurs figures a analyser. CHAQUE figure produit un effet different.' },
                    { question: 'Quelle figure ? "Ici la Haine buvait dans le crane de la Douceur." (Hugo)', answer: 'ALLEGORIE doubleed d\'une personnification. La Haine et la Douceur (abstractions) agissent comme des personnes. La majuscule est un INDICE. '
                        + 'Hugo dramatise l\'opposition entre violence et tendresse en les transformant en personnages. '
                        + '\uD83D\uDCA1 ASTUCE : majuscule sur un nom abstrait (Amour, Mort, Haine, Justice) = probable allegorie. L\'allegorie est la figure preferee de Hugo.' },
                    // --- PROSOPOPEE ---
                    { question: 'Qu\'est-ce qu\'une prosopopee ? Pourquoi est-ce la figure la plus audacieuse ?', answer: 'La prosopopee fait PARLER ce qui ne peut pas parler : un mort, un absent, un objet, une abstraction. C\'est une personnification poussee a l\'extreme. '
                        + 'Exemple : "O murs de la patrie, si vous pouviez parler..." L\'orateur donne la parole aux murs. '
                        + '\uD83D\uDCA1 ASTUCE MEMO : Prosopopee = Prise de PArole (les deux commencent par P). La prosopopee transgresse les lois de la nature : elle fait parler les pierres et les morts.' },
                    { question: 'Quelle figure ? "Je suis la pipe d\'un auteur [...] Quand il est comble de douleur, / Je fume comme une chaumine." (Baudelaire, La Pipe)', answer: 'PROSOPOPEE. La pipe prend la parole et dit "Je suis". Baudelaire fait parler un OBJET a la premiere personne. '
                        + 'L\'effet est intime et etrange : l\'objet quotidien revele la vie interieure du poete. '
                        + '\uD83D\uDCA1 La prosopopee permet de changer de perspective : voir le monde a travers les yeux d\'un objet, d\'un animal, d\'un mort. C\'est une figure de l\'empathie radicale.' },
                    // --- CATACHRESE ---
